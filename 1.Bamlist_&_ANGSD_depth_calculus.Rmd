...
do
echo "$POP --> $POP1"
ls /GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/*${POP1}_*_recal_round-1.bam  >> "$POP".bamlist
done
...
# Only pardinus: --> Done 20/06/2017
POPS=(c_lp_do-c_lp_sm)
# Lynx lynx wo balcans: --> Done 16/08/2019
POPS=(c_ll_no-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl)
...
do
echo "$POP --> $POP1"
ls /GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final//BAM_intergenic_5x/*${POP1}*intergenic.bam  >> "$POP".intergenic.bamlist
done
...
--> Lynx lynx wo balcans (16/08/2019)
POPS=(c_ll_no-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl)
...
POP=(c_ll_no-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl_n077)
...
## Ojo la forumula para calcular truncated y no truncated son distintas. En principio nosotros queríamos aplicar la primera, pero por error, hemos mantenido la segunda. En cualquier caso, no nos parece mala idea. Estamos filtrando aprox una desviacióne standard. 

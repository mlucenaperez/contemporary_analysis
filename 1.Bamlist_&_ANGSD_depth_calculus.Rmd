...
h_ll_ba       "
c_ll_cr (including 25x MACROGEN sample) --> Previously done
c_ll_cr (including subsampled MACROGEN sample) -->  To do
c_ll_po --> Previously done
c_ll_la --> Previously done
c_ll_ki (including 25x MACROGEN sample) -->  Previously done
c_ll_ki (including subsampled MACROGEN sample) -->  To do
c_ll_ur
c_ll_tu --> Done
c_ll_to --> Previously done
c_ll_ka --> No
c_ll_og --> No
c_ll_ya (including 25x MACROGEN sample) --> Previously done
c_ll_ya (including subsampled MACROGEN sample) -->  To do
c_ll_vl (including 25x MACROGEN sample) --> Previously done
...
POP="c_ll_ki_n0"  # <--CHANGE POP HERE

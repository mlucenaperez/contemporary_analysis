...
echo -e "sample\taverage\tstdev" > global_coverage.tsv
for sample in "${SAMPLELIST[@]}"
do
echo $sample
...
maxDepth_DF = my_mean_DF * sd_folds
minDepth_DF  = my_mean_DF * sd_folds
maxDepth_truncated_DF = my_mean_truncated_DF * sd_folds
minDepth_truncated_DF  = my_mean_truncated_DF * sd_folds
...
ggplot(freq_table_truncated_DF, aes(x = value, y = freq)) + 
  ...
  ggtitle (paste(my_files_depthGlobal[i],"_", sd_folds, "_",maxDepth_truncated_DF, "_",maxDepth_DF) ) +
...
plot_name=paste(my_files_depthGlobal[i],"_",sd_folds,".pdf",sep="")
ggsave(filename = plot_name)

}

#When finished write the table to sfs folder
write.csv(x = depth_per_sample,file = paste("/Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_sd_folds_",sd_folds,".csv", sep= ""))
write.table(x = depth_per_sample,file = paste("/Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_sd_folds_",sd_folds,"_a.csv", sep= ""),quote=FALSE, col.names = FALSE, row.names = FALSE, sep= " ")

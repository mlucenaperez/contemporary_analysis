...
# BARCODE MACROGEN:
# declare -A BARCODEID=(["LC1"]="c_lc_xx_0001" ["LL112"]="c_ll_vl_0112" ["LL146"]="c_ll_ya_0146" ["LL212"]="c_ll_cr_0212" ["LL90"]="c_ll_ki_0090" ["LR1"]="c_lr_xx_0001")
```
...
echo "sample_name,total_seq,total_reads,duplicates,mapped" > raw.stats 
for sample in "${SAMPLELIST[@]}"
do
echo "${sample}"
NAME="${sample}"
...
echo "$NAME,$TOTAL_SEQ,$TOTAL_READS,$DUPLICATES,$MAPPED" >> raw.stats 
done

...
2) Then we are doing an overlap with intergenic sites from notation (we will create a BED file X intergenic). How many sites does it have? If there are too many, we will reduce it to ~2.5Mb to have a proper compare with our intergenic autosomal sites. 

...
awk -v OFS='\t' '{split($0,a,":"); if ($7=="+") print $1,"manual","promoter_gene_250",$4-250,$4-1,$6,$7,$8,$9"_promoter"; else print $1,"manual","promoter_gene_250",$5+1,$5+251,$6,$7,$8,$9"_promoter"}'>> LYPA23C.promoters_full_length_genes.nr.250bp.gff3

echo "$GENEID 500"
grep "$GENEID" LYPA23C.all.fix.nr.gff3 | grep -P 'EVM_PASA\tmRNA'  | \
awk -v OFS='\t' '{split($0,a,":"); if ($7=="+") print $1,"manual","promoter_gene_500",$4-500,$4-1,$6,$7,$8,$9"_promoter"; else print $1,"manual","promoter_gene_500",$5+1,$5+501,$6,$7,$8,$9"_promoter"}'>> LYPA23C.promoters_full_length_genes.nr.500bp.gff3

echo "$GENEID 1000"
grep "$GENEID" LYPA23C.all.fix.nr.gff3 | grep -P 'EVM_PASA\tmRNA'  | \
awk -v OFS='\t' '{split($0,a,":"); if ($7=="+") print $1,"manual","promoter_gene_1000",$4-1000,$4-1,$6,$7,$8,$9"_promoter"; else print $1,"manual","promoter_gene_1000",$5+1,$5+1001,$6,$7,$8,$9"_promoter"}'>> LYPA23C.promoters_full_length_genes.nr.1000bp.gff3
...
awk -v OFS='\t'  '{if ($4<0) print $1,$2,$3,"1",$5,$6,$7,$8,$9; else print $0}' $promoters_gene_list | awk '$5!=0 && $5!=1 {print $0}' | LANG=en_EN sort -k 1,1 -k 4,4n -k 5,5n > ${promoters_gene_list/.nr./.fix.}
...
# Results from removing bases with one
...
# 7391 LYPA23C.promoters_full_length_genes.fix.500bp.gff3
...
for promoters_gene_list in LYPA23C.promoters_full_length_genes.nr*
do
join -1 1 -2 1 /GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23 $promoters_gene_list | awk '{print $0, $2-$6}' | awk '{if ($11>0) print $1,$3,$4,$5,$6,$7,$8,$9,$10, $2; else print $1,$3,$4,$5,$2,$7,$8,$9,$10,$2 }' > ${promoters_gene_list/.nr./.fix.}
awk '{print $10-$5}' ${promoters_gene_list/.nr./.fix.} | sort -n  > ${promoters_gene_list/.nr./.borrar.} # con este archivo luego comprobamos que la resta está bien hecha.  
mv ${promoters_gene_list/.nr./.fix.} $promoters_gene_list
done


head LYPA23C.promoters_full_length_genes.borrar.250bp.gff3 --> ok
head LYPA23C.promoters_full_length_genes.borrar.500bp.gff3 --> ok
head LYPA23C.promoters_full_length_genes.borrar.1000bp.gff3 --> ok
...
awk -v OFS='\t' '{if ($4=="+") print $1,"manual","promoter_lncRNA_250",$2-250,$2-1,".",$4,".","GID='${LNCRNA_ID}'_promoter"; else print $1,"manual","promoter_lncRNA_250",$3+1,$3+251,".",$4,".","GID='${LNCRNA_ID}'_promoter"}' >> LYPA23C.promoters_lncRNA.250bp.gff3

echo "$LNCRNA_ID 500"
grep "$LNCRNA_ID" LYPA23C.lncRNAs_fixed_sorted.gff3 | \
awk -v OFS='\t' 'NR == 1 {min = $4} NR>1 && $4<min {min = $4}; NR == 1 {max = $5} NR>1 && $5>max {max = $5} END {print  $1,min,max,$7}' | 
awk -v OFS='\t' '{if ($4=="+") print $1,"manual","promoter_lncRNA_500",$2-500,$2-1,".",$4,".","GID='${LNCRNA_ID}'_promoter"; else print $1,"manual","promoter_lncRNA_500",$3+1,$3+501,".",$4,".","GID='${LNCRNA_ID}'_promoter"}' >> LYPA23C.promoters_lncRNA.500bp.gff3

echo "$LNCRNA_ID 1000"
grep "$LNCRNA_ID" LYPA23C.lncRNAs_fixed_sorted.gff3 | \
awk -v OFS='\t' 'NR == 1 {min = $4} NR>1 && $4<min {min = $4}; NR == 1 {max = $5} NR>1 && $5>max {max = $5} END {print  $1,min,max,$7}' | 
awk -v OFS='\t' '{if ($4=="+") print $1,"manual","promoter_lncRNA_1000",$2-1000,$2-1,".",$4,".","GID='${LNCRNA_ID}'_promoter"; else print $1,"manual","promoter_lncRNA_1000",$3+1,$3+1001,".",$4,".","GID='${LNCRNA_ID}'_promoter"}' >> LYPA23C.promoters_lncRNA.1000bp.gff3
...
awk -v OFS='\t'  '{if ($4<0) print $1,$2,$3,"1",$5,$6,$7,$8,$9; else print $0}' $promoters_lncRNA_list | awk '$5!=0 && $5!=1 {print $0}' | LANG=en_EN sort -k 1,1 -k 4,4n -k 5,5n > ${promoters_lncRNA_list/bp./fix.}
echo `wc -l ${promoters_lncRNA_list/bp./fix.}`
mv ${promoters_lncRNA_list/bp./fix.} $promoters_lncRNA_list
done

# LYPA23C.promoters_lncRNA.1000bp.gff3
# 6362 LYPA23C.promoters_lncRNA.1000bp.gff3
# 6360 LYPA23C.promoters_lncRNA.1000fix.gff3
# LYPA23C.promoters_lncRNA.250bp.gff3
# 6362 LYPA23C.promoters_lncRNA.250bp.gff3
# 6360 LYPA23C.promoters_lncRNA.250fix.gff3
# LYPA23C.promoters_lncRNA.500bp.gff3
# 6362 LYPA23C.promoters_lncRNA.500bp.gff3
# 6360 LYPA23C.promoters_lncRNA.500fix.gff3


#### Sanity check --> ok
awk '{print $5-$4}' LYPA23C.promoters_lncRNA.250bp.gff3 | sort -n | head
awk '{print $5-$4}' LYPA23C.promoters_lncRNA.500bp.gff3 | sort -n | head
awk '{print $5-$4}' LYPA23C.promoters_lncRNA.1000bp.gff3 | sort -n | head
#### 

# Ahora recortamos por el otro lado. 

#### Sanity cehck --> 
# Primero comprobamos que todos están en el (-)
rm borrar
for promoters_lncRNA_list in LYPA23C.promoters_lncRNA*
do
join -1 1 -2 1 /GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23 $promoters_lncRNA_list | awk '{print $0, $2-$6}' | sort -nk 11,11 | awk '{if ($11<0) print $0}' | awk '{if ($8=="+") print $0}' >> borrar
done
# He hecho cat de borrar y no había nada así que está bien. 
rm borrar
# Todos los que se escaparían están en el -.
for promoters_lncRNA_list in LYPA23C.promoters_lncRNA*
do
join -1 1 -2 1 /GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23 $promoters_lncRNA_list | awk '{print $0, $2-$6}' | sort -nk 11,11 | awk '{if ($11<0) print $0}' | awk '{if ($8=="-") print $0}' | wc -l >> borrar
done
cat borrar 
# 60
# 44
# 52
rm borrar
# Hay 52 casos en los que solapa con el final del scaffold.  
########## 
...
bedtools subtract -a /home/mlucena/grupolince/reference_genomes/lynx_pardinus_genome/bed_file_all_the_genome.bed -b LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.bed > LYPA23C.intergenic.gff3
...
awk -v OFS='\t' '{if () print $1, $4-1001, $5+1000 }' LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.gff3 | bedtools merge -i stdin -d 1 > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.PLUS1000bp.bed


# Define intergenic region

bedtools subtract -a /home/mlucena/grupolince/reference_genomes/lynx_pardinus_genome/bed_file_all_the_genome.bed -b LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.PLUS1000bp.bed > LYPA23C.intergenic.PLUS1000.gff3

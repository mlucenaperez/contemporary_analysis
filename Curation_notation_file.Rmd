...
awk -v OFS='\t'  '{if ($4<0) print $1,$2,$3,"1",$5,$6,$7,$8,$9; else print $0}' LYPA23C.promoters_full_length_genes.nr.250bp.gff3 | sort -nk 4,4 | head 



# Tengo que corregir esto!

lp23.s00904	manual	promoter_gene_250	-138	111	.	+	.	ID=LYPA23C011008T1
...
sort -nk 4,4 LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.gff3 | awk '($4<0){print $3}' | sort | uniq -c 
     # 13 promoter_gene_1000
     #  9 promoter_gene_250
     # 10 promoter_gene_500
     # 32 promoter_lncRNA_1000
     # 20 promoter_lncRNA_250
     # 24 promoter_lncRNA_500
...
awk -v OFS='\t' '{print $1, $4-1001, $5+1000 }' LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.gff3 | bedtools merge -i stdin -d 1 > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.nr.PLUS1000bp.bed

...
awk -v OFS='\t' '{print $1,"manual","intron_lncRNA",$2+1, $3-1,".","'${direction}'",".","GID='${LNCRNA_ID}'" }' whole.lncRNA.iter.borrar | awk -v OFS='\t' '{if ($9==prev) counter++; else counter=1; print ($1,$2,$3,$4,$5,$6,$7,$8,$9"_intron_"counter); prev=$9}'  >>  LYPA23C.introns_lncRNA.gff3

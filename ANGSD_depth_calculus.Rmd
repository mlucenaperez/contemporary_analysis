...
for (i in 1:length(my_files_depthGlobal)) 
  {
DF = read.table(my_files_depthGlobal[i],head=F, stringsAsFactors=F, check.names=FALSE)
...
# maxDepth_DF = my_mean_DF + (mean_folds * my_sd_DF)
# minDepth_DF  = my_mean_DF - (mean_folds * my_sd_DF)
...
maxDepth_DF = my_mean_DF * mean_folds
minDepth_DF  = my_mean_DF / mean_folds
maxDepth_truncated_DF = my_mean_truncated_DF * mean_folds
minDepth_truncated_DF  = my_mean_truncated_DF / mean_folds
...
plot_name=paste(my_files_depthGlobal[i],"_",mean_folds,".pdf",sep="")
ggsave(filename = plot_name)

}

#When finished write the table to sfs folder
write.csv(x = depth_per_sample,file = paste("/Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_mean_folds_",mean_folds,".csv", sep= ""))
write.table(x = depth_per_sample,file = paste("/Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_mean_folds_",mean_folds,"_a.csv", sep= ""),quote=FALSE, col.names = FALSE, row.names = FALSE, sep= " ")

```
```{r, engine=bash, eval=FALSE}
scp /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_mean_folds_2*.csv mlucena@genomics-b.ebd.csic.es:/home/mlucena/do_depth_european/

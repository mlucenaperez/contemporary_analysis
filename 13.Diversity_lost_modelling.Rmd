...
<<<<<<< HEAD
model_name <- "mod_CDS_c_ll_ki_c_ll_no_delta_round_informative_cat_position_recomb_diver_GC_rvis_recomb_rvis_interaction_ziP"
=======
model_name <- "mod_CDS_c_ll_ki_c_ll_no_delta_round_*1000_recombination_rvis_GC_divergence_ziP"

>>>>>>> 1cb898cbf3c9a568b8750cbd19cba5d16a82ca87


 model2  <- gam (test$delta_round ~
# Covariables: las metemos como explicativas #  
  #s(informative_sites.x, bs="tp") +
# Explicativas  
  s(test$recombination_rate_scale)+
  s(test$divergence_scale)+
  s(test$GC_content_scale)+
  s(test$rvis_score_scale)+
  ti(test$recombination_rate_scale, test$rvis_score_scale, bs=c("tp", "tp")),
# Explicativas  

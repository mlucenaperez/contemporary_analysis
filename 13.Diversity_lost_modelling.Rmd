...
model_name <- "mod_CDS_c_ll_ki_c_ll_no_residuals_lm(watersonfinal-watersoninitial)_informative_sites_cat_position_recombination_rvis_GC_divergence_smoth_chr_interaction_rvis_recomb_zero_truncated"
...
# Covariables: las metemos como explicativas #  
  ...
  s(middle_position_cat, by=chr) + 
 # s(watterson_zero.x_scale, chr, bs = "fs") +
# Explicativas  

...
=======
   dplyr::mutate (middle_position_cat=cat_position_start+(cat_length/2)) %>% 
>>>>>>> 72c2b2f9ee84306c475c6cf11c26c693cfffd9c3
  select (comparison,
          scaffold,
          start_cero_based,
          cat_position_start,
...
```{r}
model_name <- "mod_CDS_c_lp_sm_c_lp_do_delta_round_informative_cat_position_recomb_diver_GC_rvis_recomb_rvis_interaction_ziP"
load(paste0(wd_output,model_name), .GlobalEnv)


kk <- predict(model2,type="response")
...
No esta tan mal
repetir filtrando los outliers!

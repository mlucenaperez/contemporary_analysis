...
<<<<<<< HEAD
model_name <- "mod_CDS_c_ll_ki_c_ll_no_k.y_k.x_recombination_rvis_GC_divergence_interaction_rvis_recomb_offset_informative_sites"

dataframe_test <- dataframe %>% mutate (delta_k = k.y-k.x)
hist(dataframe_test$delta_k)
=======
model_name <- "mod_CDS_c_ll_ki_c_ll_no_k.y_cat_position_recombination_rvis_GC_divergence_smoth_chr_interaction_rvis_recomb_offset_log_informative_sites"
>>>>>>> c42fc1a19c1a0ab6431403f5d69a9106aeb13c95

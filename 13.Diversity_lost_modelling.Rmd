...
hist(CDS_c_ll_ki_c_ll_no_dataframe$k.x)
hist(CDS_c_ll_ki_c_ll_no_dataframe$k.y)
...
model_name <- "mod_CDS_c_ll_ki_c_ll_no_delta_watterson_watterson_zero_informative_sites_recombination_rvis_GC_divergence_offset_informative_sites_zero_truncated_chr_size"

model_name <- "mod_CDS_c_ll_ki_c_ll_no_watterson_Bpop_watterson_zero_informative_sites_recombination_rvis_GC_divergence_offset_log_informative_sites_not_scaled_zero_truncated"

model_name <- "mod_CDS_c_ll_ki_c_ll_no_watterson_Bpop_watterson_zero_k5"

model_name <- "mod_CDS_c_ll_ki_c_ll_no_K_Bpop_K.x_recombination_rvis_GC_divergence_not_scaled_GAMMA_identity_family"

model_name <- "mod_CDS_c_ll_ki_c_ll_no_delta_watterson_watterson_zero_informative_sites_recombination_rvis_GC_divergence_factor_smooth_chr_cat_possition"

model_name <- "mod_residuals_initial_diversity_vs_final_diversity_informative_sites_recombination_divergence_GC_rvis_recomb_rvis_itera_smooth_factor_chr"

model2  <- bam (resid ~
 # Covariables: las metemos como explicativas #  
                    s(informative_sites.x, bs="tp") +
                    #s(middle_position_cat, by=chr) + 
                    #s(watterson_zero.x_scale) +
                    # Variables explicativas # 
                    s(recombination_rate_scale, chr, bs="fs")+
                    s(divergence_scale, chr, bs="fs")+
                    s(GC_content_scale, chr, bs="fs")+
                    s(rvis_score_scale, chr, bs="fs")+

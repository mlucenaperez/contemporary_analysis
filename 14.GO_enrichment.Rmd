...
write.table(allRes, paste0(wd, "topGO/results/", name, "_results_GO_enrichment_BP.txt"), quote = F, row.names = F)
...
write.table(allRes, paste0(wd, "topGO/results/", name, "_results_GO_enrichment_CC.txt"), quote = F, row.names = F)
...
write.table(allRes, paste0(wd, "topGO/results/", name, "_results_GO_enrichment_MF.txt"), quote = F, row.names = F)

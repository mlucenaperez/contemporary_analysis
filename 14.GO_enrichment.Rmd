...
c_ll_ki_n013_c_ll_no_n008 <- dplyr::inner_join(read.table (paste0(wd,"list_genes_of_interest_c_ll_ki_n013_c_ll_no_n008_high_diversity_ratio_1_watterson_trimmed.txt", sep="")), tabla_all_genes_GO_term_complete_info, by=c("V1"="GENE_NAME")) 

...
# 3. CYTOSCAPE: GO annotation enrichment map.
...
write.table(allRes, paste0(wd, "topGO/results/", names(DATAFRAMES)[i], "_results_GO_enrichment_BP.txt"), quote = F, row.names = F)

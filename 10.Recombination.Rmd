...
## 2.2 Intersect de esas unidades con coordenadas gato
...
```{bash}
awk -v OFS='\t' '{split ($8, a, ":"); split(a[3],b, "-"); print a[2], b[1], b[2], $4 }' list_of_units_with_chr_info_in_lynx_no_duplicates_cat_coordinates_lynx_coordinates_information.bed | sort -k1,1 -k2,2n | bedtools merge -i stdin -c 4 -o distinct -delim ";" > list_of_units_with_chr_info_in_lynx_no_duplicates_cat_coordinates.bed
...
Para hacer este liftOver, tenemos que pasar de la version felCat5 a la versión felCat4, y de ahi a felCat3 y luego a felCat8,en la página web http://rohsdb.cmb.usc.edu/GBshape/cgi-bin/hgLiftOver.

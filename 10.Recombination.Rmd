...
intersectBed -sorted -wao -a hglft_genome_6243_dcc890_sorted.bed -b list_of_units_with_chr_info_in_lynx_no_duplicates_cat_coordinates_information_sorted.bed | awk -v OFS='\t' '{print $1,$2,$3,$4,$5,$9,$10}' | sort -k1,1 -k2,2n -k3,3n -k6,6 |  groupBy -i stdin -g 1,2,3,4,5,6 -c 7 -o sum > recombination_rate_per_unit_all_info.bed

...
A partir de aquí defino las UCR teninedo en cuenta solo unas coordenadas por UCR (para más información mirar el script de UCR), redefino lo que es funcional y lo que es intergénico y logro un archivo definitivo. 

Ya voy a aprovechar y voy 


### 3.h. UCNE

```{bash}
# Mi archivo es: /home/mlucena/grupolince/ultra_conserved_regions/lynx_coordinates_UCNE_merged_coordinates_filtered.bed

awk -v OFS='\t' '{print $1,"manual","UCNE",$2+1,$3,".", "-", ".", "ID="$4 }' /home/mlucena/grupolince/ultra_conserved_regions/lynx_coordinates_UCNE_merged_coordinates_filtered.bed > LYPA23C.UCNE.gff3
...
Fusiono todo lo funcional creado hasta ahora.


```{bash}

cat LYPA23C.GENE.mRNA.CDS.fix.nr.gff3 LYPA23C.promoters_full_length_genes.nr.250bp.gff3 LYPA23C.promoters_full_length_genes.nr.500bp.gff3 LYPA23C.promoters_full_length_genes.nr.1000bp.gff3 LYPA23C.introns.nr.gff3 LYPA23C.UTRs_gene-cds.nr.gff3 LYPA23C.infernal_1e6_fixed.gff3 LYPA23C.lncRNAs_fixed_sorted.gff3 LYPA23C.introns_lncRNA.gff3 LYPA23C.promoters_lncRNA.250bp.gff3 LYPA23C.promoters_lncRNA.500bp.gff3 LYPA23C.promoters_lncRNA.1000bp.gff3 LYPA23C.UCNE.gff3 | LANG=en_EN sort -k 1,1 -k 4,4n -k 5,5n > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3



# Sanity check:

cut -f 3 LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3 | sort | uniq
...
cut -f 3 LYPA23C.UCNE.gff3 | sort | uniq
...
awk -v OFS='\t' '{print $1, $4-1, $5}' LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3 | bedtools merge -i stdin -d 1 > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.bed

#### ---> Sanity check:
# wc -l LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3
# 472357 LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3

# wc -l LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.bed
# 32054 LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.bed

##### 

# Define intergenic region 1-based!!

bedtools subtract -a /home/mlucena/grupolince/reference_genomes/lynx_pardinus_genome/bed_file_all_the_genome.bed -b LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.bed > LYPA23C.intergenic.bed
...
awk -v OFS='\t' '{$4=$4-1000; $5=$5+1000; print}' LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3 > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.PLUS1000bp.DO_NOT_USE.gff3
...
join -1 1 -2 1 <(cat /GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23)  <(LANG=en_EN sort -k 1,1 -k 4,4n -k 5,5n LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.PLUS1000bp.DO_NOT_USE.gff3) | awk -v OFS='\t' '{if ($5<0) {$5="1"} else {$5=$5}; print}' | awk -v OFS='\t' '{if ($6>$2) {$6=$2} else {$6=$6}; print $1,$5-1,$6}' | bedtools merge -i stdin -d 1 > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.PLUS1000bp.DO_NOT_USE.bed
...
bedtools subtract -a /home/mlucena/grupolince/reference_genomes/lynx_pardinus_genome/bed_file_all_the_genome.bed -b LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.PLUS1000bp.DO_NOT_USE.bed > LYPA23C.intergenic.PLUS1000.bed
...
# ¿Cuanto supone este intergénico?
  
awk 'sum+=($3-$2){print sum}' LYPA23C.intergenic.PLUS1000.bed
# 1481584282 bases
# total: 2413209059; por tanto suponen un 61.4% del genoma
```
...
cat LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.nr.gff3 LYPA23C.intergenic.PLUS1000.gff3 | LANG=en_EN sort -k 1,1 -k 4,4n -k 5,5n > LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3 
...
wc -l LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3
539982 LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3

# ¡Cuidado con los tabs!

grep -v "EVM_PASA      gene" LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3 | grep -v "EVM_PASA        mRNA" | wc -l
497482

# I will compute way less sites, so I will use this file with no genes or mRNA. 
grep -v "EVM_PASA      gene" LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3 | grep -v "EVM_PASA  mRNA" > LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3

wc -l LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3
497482 # Correcto!


# Now I will separate it by scaffolds. 
mkdir LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3.PerScaffold
cd LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3.PerScaffold

# Create multiple files base on one column: gff3:
awk '{print >> $1; close($1)}' ../LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3

# Rename gff3.
for file in lp23*
do
echo $file
mv $file ${file/lp23/LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3_lp23}
done
...
Esta parte del script se corría desde 3.g, obviando lo que hay a partir de ahí que es todo nuevo. 

Estos archivos tienen algunos errores puesto que los UCNE (UCR) están duplicados en algunos casos (ya que la sintenia no era contigua), y por tanto el intergenic que sale a partir de estos también estaría mal. De hecho con el intergenci tuve que hacer dos correcciones porque primero no estaban incluidos las UCR como funcional y por tanto también estas bases contaban como intergenic, y despues ya si las incluí. Independientemente, en mi script new tengo en cuenta todos estos asuntos. 
...
2:
LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCR.intergenic.nr.gff3 --> Usado y creado para el paper de diversidad por unidad y con el que lancé los valores de diversidad que despues corregí para modificar el intergénico.

3: 
LYPA23C.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.UCNE.intergenic.nr.gff3 --> Este es el archivo definitivo bueno. Con el he corregido los valores de diversidad para UCNE e intergenic que había calculado usando el anterior. Las demás unidades no las volví a correr porque en principio están bien. 

...
echo "sample_name,total_seq,total_reads,duplicates,mapped,uniq_mapped,uniq_mapped_vs_total_reads,duplicates_vs_total_reads" > hcal_LYNX_14_LYNX_17.stats 
...
echo "$NAME,$TOTAL_READS,$DUPLICATES,$MAPPED,$UNIQ_MAPPED,$UNIQ_MAPPED_vs_TOTAL_READS,$DUPLICATES_vs_TOTAL_READS" | sed 's/ //g' >> hcal_LYNX_14_LYNX_17.stats 
done
...
echo -e "sample_name\tcoverage_based_samtools\tstdev_based_samtools" > global_coverage_LYNX_17.tsv
for sample in "${SAMPLELIST[@]}"
do
echo $sample

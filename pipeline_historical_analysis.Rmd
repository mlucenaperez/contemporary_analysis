...
#Outputting Ts/Tv summary
#Ts/Tv ratio: 2.195
#After filtering, kept 10899647 out of a possible 10899647 Sites
...
| grep -v "GT:GQ:DP:RO:QR:AO:QA:GL[[:space:]]0:" | vcffilter -g "GT = 1" | vcffixup - | vcffilter -f "AC > 0" 


vcfstats $MY_VCF | grep "ts\|bial"

...
do
samtools view $sample | head -n 1000000 | cut -f 10 | perl -ne 'chomp;print length($_) . "\n"' | sort | uniq -c > ${sample/.bam/.legthdistribution}
done
...
Esto te da una distribución que para una muestra cualquiera es:

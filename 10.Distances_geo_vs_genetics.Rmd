...
ggplot(geo_genetic_distances, aes (log(geographic_distance), genetic_distance, linetype=comparison)) +
  ...
  ggplot(geo_genetic_distances %>% filter(comparison=="West-West"), aes (log(geographic_distance), genetic_distance, fill=pop_status, color=pop_status)) +
  geom_point(alpha = 0.05, aes(shape=comparison)) +
  scale_shape_manual(values=c(3, 17, 16)) +
  scale_linetype_manual(values=c("twodash", "solid", "dotted")) +
  theme_classic() +
...
# Article --> color
  ...
  labs(
    ...
    y = "Genetic distance" ) +
  theme(legend.position="top", legend.title = element_blank()) 
  ggsave("/Users/marialucenaperez/Owncloud/publico/PhD/Eurasian_lynx_phylogeography/Geo_distances/genetic_distance_vs_geographic_distance_color_nobt.pdf")
  ...
  labs(
    ...
    y = "Genetic distance" ) +
  theme(legend.position="top", legend.title = element_blank()) 
  ggsave("/Users/marialucenaperez/Owncloud/publico/PhD/Eurasian_lynx_phylogeography/Geo_distances/genetic_distance_vs_geographic_distance_color_all_pops.pdf")

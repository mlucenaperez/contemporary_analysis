...
# OJO! 
Hay dos fastq que se llaman igual! C9KNWANXX_2_LYNX7-709ii5-4 en LYNX_14 y en LYNX_17.
...
bwa aln -l 999 -t 8 $REF ${i}_merged.fastq.gz > ${i}.sai
bwa aln -l 999 -t 8 $REF ${i}_R1_trimmed2.fastq.gz > ${i}_1.sai #you can now use a fastq file.
bwa aln -l 999 -t 8 $REF ${i}_R2_trimmed2.fastq.gz > ${i}_2.sai 

### map reads

bwa samse /raid6/mlucena/lynx_genome/lp23.fa ${i}.sai ${i}_merged.fastq.gz > ${i}.sam
bwa sampe /raid6/mlucena/lynx_genome/lp23.fa ${i}_1.sai ${i}_2.sai ${i}_R1_trimmed2.fastq.gz  ${i}_R2_trimmed.fastq.gz > ${i}_unmerged.sam 

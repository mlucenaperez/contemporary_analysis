...
# Trimming (ya estaba hecho) y merging.
...
bwa aln -l 999 -t 10 $REF ${i}_merged.fastq.gz > ${i}.sai
...
bwa aln -l 999 -t 4 $REF ${i}_R1_trimmed2.fastq.gz > ${i}_1.sai #you can now use a fastq file.
done
...
do
echo "${i}"
bwa aln -l 999 -t 4 $REF ${i}_R2_trimmed2.fastq.gz > ${i}_2.sai 
done
...
bwa samse $REF ${i}.sai ${i}_merged.fastq.gz > ${i}.sam
bwa sampe $REF ${i}_1.sai ${i}_2.sai ${i}_R1_trimmed2.fastq.gz  ${i}_R2_trimmed.fastq.gz > ${i}_unmerged.sam 
<<<<<<< HEAD
=======
done
>>>>>>> 5a9e015c9cccd18925c0ad782c14a7d15e2df5f3
...
```{bash}
# Run Estimation of postmorten damage:

samtools index ${i}_sorted_marked_rg_sorted_indelrealigner.bam

java -jar /opt/picard-tools/picard.jar ValidateSamFile I=${i}_sorted_marked_rg_sorted_indelrealigner.bam  MODE=SUMMARY MAX_OPEN_TEMP_FILES=1000


screen -S atlas_ancient
i=/home/mlucena/grupolince/lynx_genomes_5x/raw_data/ancient_data/a_lp_ca_1309
REF=/home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/lp23.fa				

./atlas task=estimatePMD bam=${i}_sorted_marked_rg_sorted_indelrealigner.bam fasta=$REF verbose


REF=/home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/lp23.fa					

mapDamage -i a_lp_ca_1309_sorted_marked_rg_sorted_indelrealigner.bam  -r $REF --rescale
...
bwa samse $REF C9KH6ANXX_5_LYNX7-604ii5-2.sai already_done_fastq/C9KH6ANXX_5_LYNX7-604ii5-2_merged.fastq.gz > C9KH6ANXX_5_LYNX7-604ii5-2.sam
samtools view -Sb C9KH6ANXX_5_LYNX7-604ii5-2.sam > test.bam
...
REF=/home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/lp23.fa				
/home/mlucena/atlas/atlas task=estimatePMD bam=test_sorted_rg.bam fasta=$REF length=25 verbose

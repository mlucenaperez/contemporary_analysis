...
He creado este script fancy de R pero por alguna razónno me ha ce el merge en el servidor, ni con full_join ni con merge. Por tanto me voy a copiar los archivos *.qopt en dropbox y lo voy a correr ahí, y luego los borro. 

#### Copy to dropbox
```{bash}

scp mlucena@genomics-b.ebd.csic.es://home/mlucena/ANGSD_analysis/intergenic_analysis/intergenic_ADMIXTURE/*qopt /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/intergenic_analysis/analysis_ADMIXTURE/2017-10-26_Maf1/

scp mlucena@genomics-b.ebd.csic.es://home/mlucena/ANGSD_analysis/intergenic_analysis/intergenic_ADMIXTURE/*info /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/intergenic_analysis/analysis_ADMIXTURE/2017-10-26_Maf1 

```

De camino ya guardo también la tabla para correr CLUMPAK

http://clumpak.tau.ac.il/bestK.html

```{bash}

scp mlucena@genomics-b.ebd.csic.es://home/mlucena/ANGSD_analysis/intergenic_analysis/intergenic_ADMIXTURE/Ks_log_prob_table.txt /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/intergenic_analysis/analysis_ADMIXTURE/2017-10-26_Maf1/
...
#### Final graphical script FANCY (the first one used is before)
...
admix <- t(as.matrix(read.table("/Users/marialucenaperez/Desktop/c_ll_no-c_ll_ba-h_ll_ba-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl_n080_K9_run8.qopt")))
pop <- read.table("/Users/marialucenaperez/Desktop/c_ll_no-c_ll_ba-h_ll_ba-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl_n080.info")
...
do
echo $i
Rscript Admix_plot_fancy.R "$POP"_K"$i"_run$run.qopt "$POP".info $i $POP"_run"$run
done

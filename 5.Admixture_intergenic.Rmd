...
POP="c_lp_do-c_lp_sm-c_ll_no-c_ll_ba-h_ll_ba-c_ll_cr-c_ll_po-c_ll_la-c_ll_ki-c_ll_ur-c_ll_tu-c_ll_to-c_ll_ka-c_ll_og-c_ll_ya-c_ll_vl_n111.intergenic"

zcat $POP.genolike.mafs.gz | tail -n+2 | wc -l

# 6137313 sites.


# 3636950 lypa lyly sites
```
...
do
echo $i
/home/mlucena/software/NGSadmix -likes "$POP".genolike.beagle.gz -K "$i" -P 20 -o "$POP"_K"$i"_run"$a" -minMaf $MINMAF 
done  
done
...
do
echo $i
Rscript Admix_plot.R "$POP"_K"$i".qopt "$POP".info $i $POP
done
```

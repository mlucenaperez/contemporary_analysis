...
Finally to run NE-Estimator I am using the dataset with 100k SNPs developed for SNeP. I converted it to GENEPOP using PGDSpider, and then run it in local selecting comparison only ACROOSS CHROMOSOMES!!!!!

...
Ahora voy a lanzar el SNeP usando las coordenadas de gato que se han creado en este script (4.LinkNe). La idea es que un scaffold no tiene la suficiente longitud como para tnere valores de recombinación grandes, y todo lo que sea entre scaffold el programa lo esta entendiendo como que está a mucha distancia. Por eso hemos convertido nuestros snps a coordenadas de gato. 

Los VCF de gatos están en la siguiente carpeta
```{bash}
...
## Generate ped and map file
En teoria ya tambien tengo el map file para cada uno de esos archivos, pero como este script te corre automáticamente ambos, 
```{bash}
cd /GRUPOS/grupolince/recent_demographic_reconstruction
...
scp mlucena@genomics-b.ebd.csic.es:/GRUPOS/grupolince/recent_demographic_reconstruction/*ped /home/maria/SneP
scp mlucena@genomics-b.ebd.csic.es:/GRUPOS/grupolince/recent_demographic_reconstruction/*map /home/maria/SneP

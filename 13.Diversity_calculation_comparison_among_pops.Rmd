...
```{r}
ggplot(data=ratio_ratio_per_feature, aes(comparison, ratioB_ratioNB_watterson , fill=feature, color=feature))+
  geom_point()
ggsave (paste(wd_output,"ratio_ratio_NB_B_watterson.pdf", sep=""), width = 80, height = 40, units = "mm")

ggplot(data=ratio_ratio_per_feature, aes(comparison, ratioB_ratioNB_pairwise , fill=feature, color=feature))+
  geom_point()
ggsave (paste(wd_output,"ratio_ratio_NB_B_pairwise.pdf", sep=""), width = 80, height = 40, units = "mm")
```
...
ggplot(data = data.frame(all_popsr2N), aes(x = comparison, y = region, fill= r.squaredN)) + 
  ...
  theme_minimal() +
ggsave(paste(wd_output, "all_popsr2N_heatmap_regions_comparisons.pdf", sep=""), width = 160, height = 160, units = "mm")
...
ggsave(paste(wd_output, "all_popspredictN_heatmap_regions_comparisons.pdf", sep=""), width = 160, height = 160, units = "mm")

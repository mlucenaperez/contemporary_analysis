...
create_data_diversity_bootleneck_vs_non_bootleneck <- function(POP1, POP2, name_POP1, name_POP2){
  ...
  data_diversity_POP1_POP2 <- dplyr::inner_join (POP1, POP2, by = c("scaffold", "start_cero_based", "end", "length", "feature", "strandness", "frame", "id_gene", "id", "region", "chr", "unique_id", "recombination_rate", "recomb", "type_chr", "divergence", "informative_sites_substitutions", "substitutions", "GC_content", "rvis_score")) %>%  
      # Calculo el delta 

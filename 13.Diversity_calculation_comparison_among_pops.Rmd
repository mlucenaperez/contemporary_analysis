...
### Ratio X/A
ratio_x_a_per_pop <- read.table(paste(wd_input_stats,"ratio_x_a_per_pop.txt",sep=""), row.names = NULL, dec="," , header=T)
ratio_x_a_per_pop_per_feature <- read.table(paste(wd_input_stats,"ratio_x_a_per_pop_per_feature.txt",sep=""), row.names = NULL, dec="," , header=T)
...
Toda esta parte ya se hace con ventanas, así que no se corre. 
...
### U-MW and effect size diversity lost (HD)
...
#"c_ll_ki_n013_diversity_c_ll_no_n008_diversity_categories_pairwise", "c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_pairwise", "c_lp_sm_n019_diversity_c_lp_do_n012_diversity_categories_pairwise"
...
DATAFRAME_filtered <- get(DATAFRAME) %>% filter(., diversity_category==paste0("HD_",DIVERSITY_MEASURE_CONSIDERED)) %>% filter(feature=="CDS" | feature=="Intergenic" | feature=="Intron")
...
effect_size_diversity_PI <-with(DATAFRAME_filtered,
       by(DATAFRAME_filtered, feature,
          function(x) wilcoxonR(x=x$pairwise_ave.x, g=x$evolution_category))) %>%  
  lapply(., tidy) %>% melt(list()) %>% mutate(variable="pairwise_ave.x") %>%
...
## Effect size
effect_size_informative_sites.x <-with(DATAFRAME_filtered,
       by(DATAFRAME_filtered, feature,
          function(x) wilcoxonR(x=x$informative_sites.x, g=x$evolution_category))) %>%  
  lapply(., tidy) %>% melt(list()) %>% mutate(variable="informative_sites.x") %>%
  mutate (comparison=paste0(POP1,"_", POP2)) %>% 
  mutate (method="r") %>% 
  mutate (pop1_pop2 = ifelse (comparison == "c_ll_ki_n013_c_ll_po_n008", "Kirov_Poland",
          ifelse (comparison == "c_ll_ki_n013_c_ll_no_n008", "Kirov_Norway",
...
div <-melt(list(diversity.greater.PI , diversity.less.PI)) %>% 
    mutate(genomic_variable="pairwise_evaluation_watterson_quadrants") %>% 
    spread(., variable, value)

inf<- melt (list (informative_sites.greater, informative_sites.less)) %>% 
    mutate(genomic_variable="informative_sites") %>% 
    spread(., variable, value)


lista_results <- rbind(as.data.frame(div), as.data.frame(inf)) %>% 
...
write.table(format(lista_results, digits=8, scientific=T), paste(wd_output,ruta_UMW_test_diversity,POP1,"_",POP2,"_features_UMW_test_pairwise_evaluation_watterson_quadrants_HD.txt",sep=""), row.names = F, quote=F)


resultados_effect_size <- rbind (effect_size_informative_sites.x, effect_size_diversity_PI)

write.table(format(resultados_effect_size, digits=8, scientific=T), paste(wd_output,ruta_UMW_test_diversity,POP1,"_",POP2,"_features_effect_size",DIVERSITY_MEASURE_CONSIDERED,"_",DIVERSITY_CATEGORY, ".txt",sep=""), row.names = F, quote=F, dec=",")
...
# cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_lp_sm_n019_c_lp_do_n012_effect_size_pairwise_evaluation_watterson_quadrants_HD.txt <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_no_n008_effect_size_pairwise_evaluation_watterson_quadrants_HD.txt ) <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_po_n008_effect_size_pairwise_evaluation_watterson_quadrants_HD.txt )  > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/all_pops_effect_size_pairwise_evaluation_watterson_quadrants_HD.txt

cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_lp_sm_n019_c_lp_do_n012_features_effect_sizewatterson_HD.txt <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_po_n008_features_effect_sizewatterson_HD.txt) <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_no_n008_features_effect_sizewatterson_HD.txt) > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/all_pops_features_effect_sizewatterson_HD.txt

cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_lp_sm_n019_c_lp_do_n012_features_UMW_test_pairwise_evaluation_watterson_quadrants_HD.txt <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_no_n008_features_UMW_test_pairwise_evaluation_watterson_quadrants_HD.txt) <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/c_ll_ki_n013_c_ll_po_n008_features_UMW_test_pairwise_evaluation_watterson_quadrants_HD.txt) > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/diversity_lost_UMW/all_pops_features_UMW_test_pairwise_evaluation_watterson_quadrants_HD.txt

```
### U-MW test and effect size evolutionary category vs genomic variables
...
effect_size_divergence <-with(DATAFRAME_filtered,
       by(DATAFRAME_filtered, feature,
          function(x) wilcoxonR(x=x$divergence, g=x$evolution_category))) %>%  
  lapply(., tidy) %>% melt(list()) %>% mutate(variable="divergence") %>%
  mutate (comparison=paste0(POP1,"_", POP2)) %>% 
  mutate (method="r") %>% 
  mutate (pop1_pop2 = ifelse (comparison == "c_ll_ki_n013_c_ll_po_n008", "Kirov_Poland",
          ifelse (comparison == "c_ll_ki_n013_c_ll_no_n008", "Kirov_Norway",
...
effect_size_recombination_rate <-with(DATAFRAME_filtered,
       by(DATAFRAME_filtered, feature,
          function(x) wilcoxonR(x=x$recombination_rate, g=x$evolution_category))) %>%  
  lapply(., tidy) %>% melt(list()) %>% mutate(variable="recombination_rate") %>%
  mutate (comparison=paste0(POP1,"_", POP2)) %>% 
  mutate (method="r") %>% 
  mutate (pop1_pop2 = ifelse (comparison == "c_ll_ki_n013_c_ll_po_n008", "Kirov_Poland",
          ifelse (comparison == "c_ll_ki_n013_c_ll_no_n008", "Kirov_Norway",
...
effect_size_GC_content <-with(DATAFRAME_filtered,
       by(DATAFRAME_filtered, feature,
          function(x) wilcoxonR(x=x$GC_content, g=x$evolution_category))) %>%  
  lapply(., tidy) %>% melt(list()) %>% mutate(variable="GC_content") %>%
  mutate (comparison=paste0(POP1,"_", POP2)) %>% 
  mutate (method="r") %>% 
  mutate (pop1_pop2 = ifelse (comparison == "c_ll_ki_n013_c_ll_po_n008", "Kirov_Poland",
          ifelse (comparison == "c_ll_ki_n013_c_ll_no_n008", "Kirov_Norway",
...
rvis.greater <- with(DATAFRAME_filtered2,
       by(DATAFRAME_filtered2, feature,
          function(x) wilcox.test(rvis_score ~ evolution_category, data = x, conf.int = TRUE, alternative = "greater"))) %>% lapply(., tidy) 
rvis.less <- with(DATAFRAME_filtered2,
       by(DATAFRAME_filtered2, feature,
          function(x) wilcox.test(rvis_score ~ evolution_category, data = x, conf.int = TRUE, alternative = "less"))) %>% lapply(., tidy) 
...
effect_size_rvis_score <-with(DATAFRAME_filtered2,
       by(DATAFRAME_filtered2, feature,
          function(x) wilcoxonR(x=x$rvis_score, g=x$evolution_category))) %>%  
...
### Test
resultados_U_Man_Whitney <- rbind(lista_results_divergence_melted, lista_results_recombination_melted, lista_results_GC_content_melted, lista_results_size, lista_results_rvis_melted) %>% mutate (SIG=ifelse(p.value<0.05, "SIGN", "no")) %>% mutate (comparison=paste0(POP1,"_", POP2)) %>% mutate (method="wilcox.test")
...
### Effect size
resultados_effect_size <- rbind (effect_size_informative_sites.x, effect_size_divergence, effect_size_recombination_rate, effect_size_GC_content, effect_size_rvis_score)

write.table(format(resultados_effect_size, digits=8, scientific=T), paste(wd_output,ruta_UMW_test,POP1,"_",POP2,"_features_effect_size",DIVERSITY_MEASURE_CONSIDERED,"_",DIVERSITY_CATEGORY, ".txt",sep=""), row.names = F, quote=F, dec=",")


rm(divergence.greater, divergence.less, recombination.greater, recombination.less , GC_content.greater, GC_content.less, lista_results_divergence_melted,  lista_results_recombination_melted,  lista_results_GC_content_melted, resultados_U_Man_Whitney, effect_size_informative_sites.x, effect_size_divergence, effect_size_recombination_rate, effect_size_GC_content, effect_size_rvis_score)
}
}
...
cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/genomic_variable_diversity_category_UMT_boxplot_mean/c_lp_sm_n019_c_lp_do_n012_features_effect_sizewatterson_LD.txt <(tail -n +2 /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/genomic_variable_diversity_category_UMT_boxplot_mean/c_ll_ki_n013_c_ll_no_n008_features_effect_sizewatterson_LD.txt ) <(tail -n +2  /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/genomic_variable_diversity_category_UMT_boxplot_mean/c_ll_ki_n013_c_ll_po_n008_features_effect_sizewatterson_LD.txt ) > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/genomic_variable_diversity_category_UMT_boxplot_mean/all_pops_features_effect_sizewatterson_LD.txt
```
...
all_pops$comparison <- factor (all_pops$comparison, levels=c("Kirov-NE_Poland", "Kirov-Norway", "Andujar-Donana"))
...
all_pops_filtered_HD <- all_pops %>% 
  filter(diversity_category=="HD_watterson")  %>% 
  filter (type_chr=="autosomes") %>% 
  select ("comparison","informative_sites.x","pairwise_ave.x", "evolution_category", "feature") %>% 
  mutate (feature2=ifelse(feature=="Intergenic", "Intrg", as.character(feature))) %>% 
  mutate (comparison2=ifelse (comparison =="Kirov-NE_Poland", "KIR-POL", 
                      ifelse (comparison =="Kirov-Norway", "KIR-NOR","AND-DON"))) %>% 
  select (-feature, -comparison ) %>% 
  rename (., feature = feature2) %>% 
  rename (., comparison = comparison2) %>% 
  rename (., Informative_sites=informative_sites.x) %>% 
  rename (., Initial_pi_diversity=pairwise_ave.x)
...
all_pops_filtered_LD <- all_pops %>% 
  ...
  filter (type_chr=="autosomes") %>% 
  select ("comparison","divergence", "recombination_rate", "GC_content", "informative_sites.x", "rvis_score", "feature", "evolution_category") %>% 
  mutate (feature2=ifelse(feature=="Intergenic", "Intrg", as.character(feature))) %>% 
  mutate (comparison2=ifelse (comparison =="Kirov-NE_Poland", "KIR-POL", 
                      ifelse (comparison =="Kirov-Norway", "KIR-NOR","AND-DON"))) %>% 
  select (-feature, -comparison ) %>% 
  rename (., feature = feature2) %>% 
  rename (., comparison = comparison2) %>% 
  rename (., Divergence=divergence) %>% 
  rename (., Recombination_rate=recombination_rate) %>% 
  rename (., Informative_sites=informative_sites.x) %>% 
  rename (., RVIS=rvis_score)  
...
ggplot(all_pops_filtered_HD_gather, aes(evolution_category,value, colour=evolution_category)) +
  ...
  ggsave(paste(wd_output,ruta_plot,"all_pops_HD_all_variables_mean_se_features_.pdf",sep=""), width = 80, height = 90, units ="mm")
...
geom_pointrange(stat = "summary",
  ...
  theme (axis.text.x=element_blank(),
         ...
         strip.text.x = element_text(size = 6, angle = 45),
         legend.position = "none") +
  ggsave(paste(wd_output,ruta_plot,"all_pops_HD_all_variables_median_se_features_.pdf",sep=""), width = 80, height = 90, units ="mm")


# ## Mean LD all variables all comparisons ##

ggplot(all_pops_filtered_LD_gather, aes(evolution_category,value, colour=evolution_category)) +
  facet_grid(genomic_variable~comparison+feature, 
  ...
  theme (axis.text.x=element_blank(),
         ...
         legend.position = "none") +
  ggsave(paste(wd_output,ruta_plot,"all_pops_LD_all_variables_mean_se_features_.pdf",sep=""), width = 80, height = 185, units ="mm")
...
ggplot(all_pops_filtered_LD_gather, aes(evolution_category,value, colour=evolution_category)) +
  ...
  theme (axis.text.x=element_blank(),
         ...
         strip.text.x = element_text(size = 5, angle = 45),
         legend.position = "none") +
  ggsave(paste(wd_output,ruta_plot,"all_pops_LD_all_variables_median_se_features_.pdf",sep=""), width = 80, height = 185, units ="mm")
```
...
for (DATAFRAME in DATAFRAMES)
{
  ...
  above95_bootleneck_pop_value_pairwise <- as.numeric(stats_df_pop_feature %>% filter(type_chr=="autosomes") %>% dplyr::ungroup() %>% dplyr::filter(feature=="CDS" & Populations==POPULATION2) %>% dplyr::select ("q95_pairwise_ave") %>% as.data.frame(.) %>%  .[1,1] )
  # Añadimos una columna para que se coloreen los genes que luego vamos a pasarle al GO term enrichment. Estos genes son: los que presentan ALTA diversidad en ambas poblaciones, y un delta parecido.
#  DATAFRAME_modif_pairwise <- get(DATAFRAME) %>% mutate (col=ifelse(log10(pairwise_ave.x)>min_non_bootleneck_pop_value_pairwise & log10(pairwise_ave.y)>min_bootleneck_pop_value_pairwise & ratio_pairwise_average>0.6 & ratio_pairwise_average<1.4 & feature=="CDS" & pairwise_ave.x > above95_non_bootleneck_pop_value_pairwise & pairwise_ave.y > above95_bootleneck_pop_value_pairwise, "interesting_genes", "shit"))
  ...
  ggplot(data=get(DATAFRAME), aes(x=log10(pairwise_ave.x) ,y=log10(pairwise_ave.y) )) +
...
#     ggsave (paste(wd_output,DATAFRAME,"_relation_by_feature_pairwise_interesting_CDS.pdf", sep=""), width = 7, height = 7)
  ...
  # Watterson
  above95_non_bootleneck_pop_value_watterson <- as.numeric(stats_df_pop_feature %>% filter(type_chr=="autosomes") %>% dplyr::ungroup() %>% dplyr::filter(feature=="CDS" & pop==POP1) %>% dplyr::select ("q95_watterson_ave") %>% as.data.frame(.) %>%  .[1,1] )
  above95_bootleneck_pop_value_watterson <- as.numeric(stats_df_pop_feature %>% filter(type_chr=="autosomes") %>% dplyr::ungroup() %>% filter(feature=="CDS" & pop==POP2) %>% dplyr::select ("q95_watterson_ave") %>% as.data.frame(.) %>%  .[1,1] )
...
#  DATAFRAME_modif_watterson <- get(DATAFRAME) %>% mutate (col=ifelse(log10(watterson_ave.x)>min_non_bootleneck_pop_value_watterson & log10(watterson_ave.y)>min_bootleneck_pop_value_watterson & ratio_watterson_average>0.6 & ratio_watterson_average<1.4 & feature=="CDS" & watterson_ave.x > above95_non_bootleneck_pop_value_watterson & watterson_ave.y > above95_bootleneck_pop_value_watterson, "interesting_genes", "shit"))
  # Plot de todas las features
  ggplot(data=get(DATAFRAME) , aes(x=log10(watterson_ave.x) ,y=log10(watterson_ave.y) )) +
    geom_point(alpha = 1/100, color='grey41') +
    geom_abline(intercept = 0, color='grey20') +
...
```
## *Schematic div 1 vs div 2
```{r}
DATAFRAME="c_lp_sm_n019_diversity_c_lp_do_n012_diversity"

  ## Plot article
p1 <-     ggplot(data=get(DATAFRAME) %>% filter (feature=="3UTR")  , aes(x=log10(watterson_ave.x) ,y=log10(watterson_ave.y) )) +
    geom_point( alpha = 1/20, color='grey41') +
    geom_abline(intercept = 0, color='grey20') +
    geom_hline(yintercept= min_bootleneck_pop_value_watterson, color='grey20') +
    geom_vline(xintercept = min_non_bootleneck_pop_value_watterson, color='grey20') +
    theme(legend.position="none") 
...
p3 <- ggExtra::ggMarginal(p1, type = "histogram")  


ggsave (paste0(wd_output,"schematic_pop1div_vs_pop2div_densi.pdf"), p2, width = 7, height = 7, device = "pdf")
ggsave (paste0(wd_output,"schematic_pop1div_vs_pop2div_hist.pdf"), p3, width = 7, height = 7, device = "pdf")
```
### *Sanity: Genomic variables against informative sites.
...
write.table(cases_ND_ND_region_contingency, paste(wd_output,"contingency/",POP1,"_",POP2,"_regions_in_ND_ND_vs_ND_D_watterson.txt",sep=""), row.names = F, quote=F, dec=",") 
...
write.table(chi_results_recomb, paste(wd_output,"contingency/", POP1,"_",POP2,"_low_recombination_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt",sep=""), row.names = F, quote=F, dec=",") 


# Selecciono las features para las que el test es significativo
features_recomb_signif <- filter (chi_results_recomb, p.value <0.05) %>% mutate (FEATURES=as.character (feature)) %>% select (FEATURES) %>% as.vector() %>% unlist(., use.names = FALSE)
...
for (FEATURE in features_recomb_signif) {
  print (FEATURE)
   df_temp_recomb <- cases_ND_ND %>% select (-region) %>% filter (feature==FEATURE)
...
# Ahora hago lo mismo con la region
chi_results_region <- cases_ND_ND %>%
  ...
  unnest(tidied, .drop = TRUE) %>% 
  mutate (comparison=paste0(POP1,"_", POP2)) %>% 
  mutate (variable="genomic_region") %>% 
  mutate (method="Pearson_Chi-squared") %>% 
  mutate (pop1_pop2 = ifelse (comparison == "c_ll_ki_n013_c_ll_po_n008", "Kirov_Poland",
          ifelse (comparison == "c_ll_ki_n013_c_ll_no_n008", "Kirov_Norway",
          ifelse (comparison == "c_lp_sm_n019_c_lp_do_n012", "Andujar_Donana", "NA")))) %>% 
  select (-comparison)

write.table(chi_results_region, paste(wd_output,"contingency/", POP1,"_",POP2,"_regions_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt",sep=""), row.names = F, quote=F, dec=",") 

features_region_signif <- filter (chi_results_region, p.value <0.05) %>% mutate (FEATURES=as.character (feature)) %>% select (FEATURES) %>% as.vector() %>% unlist(., use.names = FALSE)

for (FEATURE in features_region_signif) {
  print (FEATURE)
   df_temp_region <- cases_ND_ND %>% select (-recombination_category) %>% filter (feature==FEATURE)
   chi_region <- chisq.test(df_temp_region$evolution_category, df_temp_region$region)
   jpeg(paste0(wd_output,"contingency/sig/", POP1,"_",POP2,"_",FEATURE,"_coorplot_region.jpg"))
   corrplot(chi_region$residuals, is.cor = FALSE)
   dev.off()
}
...
```{bash}
cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/contingency/*low_recombination_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/contingency/all_pops_low_recombination_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt

cat /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/contingency/*regions_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt > /Users/marialucenaperez/Owncloud/publico/PhD/WG_diversity/ANGSD/sfs/pop_comparison/contingency/all_pops_regions_in_ND_ND_vs_ND_D_watterson_chi_square_results.txt
...
### Per pop
```{r}
ratio_x_a_per_pop_kir_watterson <- as.numeric(paste(ratio_x_a_per_pop %>% 
  dplyr::filter (Populations=="Kirov") %>%
  select (ratio_x_a_watterson) %>%
  droplevels(.) %>% 
  .[,1]))

ratio_x_a_per_pop_kir_pairwise <- as.numeric(paste(ratio_x_a_per_pop %>% 
  dplyr::filter (Populations=="Kirov") %>%
  select (ratio_x_a_pairwise) %>%
  droplevels(.) %>% 
  .[,1]))

ratio_x_a_per_pop_sm_watterson <- as.numeric(paste(ratio_x_a_per_pop %>% 
  dplyr::filter (Populations=="Andujar") %>%
  select (ratio_x_a_watterson) %>%
  droplevels(.) %>% 
  .[,1]))

ratio_x_a_per_pop_sm_pairwise <- as.numeric(paste(ratio_x_a_per_pop %>% 
  dplyr::filter (Populations=="Andujar") %>%
  select (ratio_x_a_pairwise) %>%
  droplevels(.) %>% 
  .[,1]))

lynx_lynx <- ratio_x_a_per_pop %>% 
  dplyr::select (Populations, ratio_x_a_watterson, error_ratio_x_a_watterson, ratio_x_a_pairwise, error_ratio_x_a_pairwise) %>% 
  filter (Populations=="Norway" | Populations=="NE_Poland") %>% 
  mutate (ratioB_ratioNB_watterson = as.numeric(as.character(ratio_x_a_watterson))/ratio_x_a_per_pop_kir_watterson) %>% 
  mutate (ratioB_ratioNB_pairwise = as.numeric(as.character(ratio_x_a_pairwise))/ratio_x_a_per_pop_kir_pairwise) %>% 
  mutate (comparison=paste0(Populations, "_Kirov")) %>% 
  select (-Populations)

lynx_pardinus <- ratio_x_a_per_pop %>% 
  dplyr::select (Populations, ratio_x_a_watterson, error_ratio_x_a_watterson, ratio_x_a_pairwise, error_ratio_x_a_pairwise) %>% 
  filter (Populations=="Donana") %>% 
  mutate (ratioB_ratioNB_watterson = as.numeric(as.character(ratio_x_a_watterson))/ratio_x_a_per_pop_sm_watterson) %>% 
  mutate (ratioB_ratioNB_pairwise = as.numeric(as.character(ratio_x_a_pairwise))/ratio_x_a_per_pop_sm_pairwise) %>% 
  mutate (comparison=paste0(Populations, "_Andujar")) %>% 
  select (-Populations)

ratio_ratio_per_pop <- rbind(lynx_lynx, lynx_pardinus)

write.table(ratio_ratio_per_pop, paste0(wd_output, "ratio_ratio_per_pop.txt"), quote = F, row.names = F)
...
### Per pop & feature
```{r}
ratio_x_a_per_pop_per_feature_kir_watterson <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::filter (Populations=="Kirov") %>%
  select (ratio_x_a_watterson, feature) %>% 
  rename (ratio_x_a_watterson_NB=ratio_x_a_watterson)

ratio_x_a_per_pop_per_feature_kir_pairwise <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::filter (Populations=="Kirov") %>%
  select (ratio_x_a_pairwise, feature) %>% 
  rename (ratio_x_a_pairwise_NB=ratio_x_a_pairwise)

ratio_x_a_per_pop_per_feature_sm_watterson <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::filter (Populations=="Andujar") %>%
  select (ratio_x_a_watterson, feature) %>% 
  rename (ratio_x_a_watterson_NB=ratio_x_a_watterson)

ratio_x_a_per_pop_per_feature_sm_pairwise <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::filter (Populations=="Andujar") %>%
  select (ratio_x_a_pairwise, feature) %>% 
  rename (ratio_x_a_pairwise_NB=ratio_x_a_pairwise)

lynx_lynx_feature <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::select (Populations,feature, ratio_x_a_watterson, error_ratio_x_a_watterson, ratio_x_a_pairwise, error_ratio_x_a_pairwise) %>%
  filter (Populations=="Norway" | Populations=="NE_Poland") %>%
  full_join (., ratio_x_a_per_pop_per_feature_kir_watterson) %>% 
  full_join (., ratio_x_a_per_pop_per_feature_kir_pairwise) %>% 
  mutate (ratioB_ratioNB_watterson = 
            as.numeric ( as.character ( ratio_x_a_watterson )) / as.numeric (as.character (ratio_x_a_watterson_NB))) %>% 
  mutate (ratioB_ratioNB_pairwise = 
            as.numeric ( as.character (ratio_x_a_pairwise)) / as.numeric (as.character(ratio_x_a_pairwise_NB))) %>% 
  mutate (comparison=paste0(Populations, "_Kirov")) %>% 
  select (-Populations)

lynx_pardinus_feature <- ratio_x_a_per_pop_per_feature %>% 
  dplyr::select (Populations,feature, ratio_x_a_watterson, error_ratio_x_a_watterson, ratio_x_a_pairwise, error_ratio_x_a_pairwise) %>%
  filter (Populations=="Donana") %>%
  full_join (., ratio_x_a_per_pop_per_feature_sm_watterson) %>% 
  full_join (., ratio_x_a_per_pop_per_feature_sm_pairwise) %>% 
  mutate (ratioB_ratioNB_watterson = 
            as.numeric ( as.character ( ratio_x_a_watterson )) / as.numeric (as.character (ratio_x_a_watterson_NB))) %>% 
  mutate (ratioB_ratioNB_pairwise = 
            as.numeric ( as.character (ratio_x_a_pairwise)) / as.numeric (as.character(ratio_x_a_pairwise_NB))) %>% 
...
ratio_ratio_per_feature <-rbind (lynx_lynx_feature, lynx_pardinus_feature)

ratio_ratio_per_feature$comparison <- factor (ratio_ratio_per_feature$comparison, levels=c("NE_Poland_Kirov", "Norway_Kirov", "Donana_Andujar"))
ratio_ratio_per_feature$feature <- factor (ratio_ratio_per_feature$feature, levels=c("Intergenic", "Intron", "CDS"))

write.table(ratio_ratio_per_feature, paste0(wd_output, "ratio_ratio_per_pop_per_feature.txt"), quote = F, row.names = F)
...
```{r}
ggplot(data=ratio_ratio_per_feature, aes(feature, ratioB_ratioNB_watterson , group=comparison, fill=comparison, color=comparison))+
  geom_point() +
  geom_line()+
  theme(legend.position = "bottom") +
  ggsave (paste(wd_output,"ratio_ratio_NB_B_watterson.pdf", sep=""), width = 80, height = 80, units = "mm")

ggplot(data=ratio_ratio_per_feature, aes(feature, ratioB_ratioNB_pairwise, group=comparison, fill=comparison, color=comparison))+
  geom_point() +
  geom_line()+
  theme(legend.position = "bottom") +
  ggsave (paste(wd_output,"ratio_ratio_NB_B_pairwise.pdf", sep=""), width = 80, height = 80, units = "mm")
...
```{r}
### Plot R^2 & a. 
COMPARISONS=c("Kirov-Norway", "Kirov-NE_Poland", "Andujar-Donana" )
REGIONS=c( "Interstitial", "Centromere", "Telomere_2m" )

data_watterson <- stats_all_pops_region_chr %>% 
  dplyr::mutate(comparison=paste0(Populations.x,"-", Populations.y)) %>% 
  filter (chr!="chrX") %>% 
  dplyr::select ("region", "chr",  "comparison", "wmean_watterson_ave.x" ,"wmean_watterson_ave.y")  %>% ungroup()

data_pairwise <- stats_all_pops_region_chr %>% 
  dplyr::mutate(comparison=paste0(Populations.x,"-", Populations.y)) %>% 
  filter (chr!="chrX") %>% 
  dplyr::select ("region", "chr",  "comparison", "wmean_pairwise_ave.x" ,"wmean_pairwise_ave.y")  %>% ungroup()
...
data_watterson_per_region_per_pop <- data_watterson %>% 
    dplyr::filter(region==REGION) %>% 
    dplyr::filter(comparison==COMPARISON) %>% 
    dplyr::select (-region, -chr, -comparison) %>% ungroup()
 
data_pairwise_per_region_per_pop <- data_pairwise %>% 
    dplyr::filter(region==REGION) %>% 
    dplyr::filter(comparison==COMPARISON) %>% 
    dplyr::select (-region, -chr, -comparison) %>% ungroup()
 
# R squared 
r2sw <- data_watterson_per_region_per_pop %>% 
    dplyr::select(-wmean_watterson_ave.x) %>%  # exclude outcome, leave only predictors 
    purrr::map(~lm(data_watterson_per_region_per_pop$wmean_watterson_ave.y ~ wmean_watterson_ave.x, data = data_watterson_per_region_per_pop)) %>% 
    purrr::map(summary) %>% 
 ...
 r2sp <- data_pairwise_per_region_per_pop %>% 
    dplyr::select(-wmean_pairwise_ave.x) %>%  # exclude outcome, leave only predictors 
    purrr::map(~lm(data_pairwise_per_region_per_pop$wmean_pairwise_ave.y ~ wmean_pairwise_ave.x, data = data_pairwise_per_region_per_pop)) %>% 
    purrr::map(summary) %>% 
    purrr::map_dbl("r.squared") %>% 
    tidy %>% 
    dplyr::arrange(desc(x)) %>% 
...
# Predictor
predict1w <- data_watterson_per_region_per_pop %>% 
  dplyr::select(-wmean_watterson_ave.x) %>%  # exclude outcome, leave only predictors 
  purrr::map(~lm(data_watterson_per_region_per_pop$wmean_watterson_ave.y ~ wmean_watterson_ave.x, data = data_watterson_per_region_per_pop)) %>% 
  purrr::map(summary) %>% 
...
predict1p <- data_pairwise_per_region_per_pop %>% 
  dplyr::select(-wmean_pairwise_ave.x) %>%  # exclude outcome, leave only predictors 
  purrr::map(~lm(data_pairwise_per_region_per_pop$wmean_pairwise_ave.y ~ wmean_pairwise_ave.x, data = data_pairwise_per_region_per_pop)) %>% 
  purrr::map(summary) %>% 
  purrr::map(broom::tidy) %>% 
  ...
  filter (variable=="predictor" )%>% 
  select (-variable)
predict2p <- as_tibble(cbind(names = names(predict1w), t(predict1w)), validate = TRUE) %>% 
  mutate(comparison=COMPARISON) %>%
  mutate(region=REGION) %>% 
  mutate(index="Pi") %>% 
  rename(., predictor = V2)

predict2p$predictor <- as.numeric(predict2w$predictor)
...
all_popspredictN <- all_popspredict %>% 
group_by(index, region) %>% 
  mutate(predictorN = predictor / mean(predictor))

# Normalize predictor, to make values comparable
all_popsr2N <- all_popsr2 %>% 
group_by(index, region) %>% 
  mutate(r.squaredN = r.squared / mean(r.squared))

# Order factor
all_popsr2N$comparison <- factor (all_popsr2N$comparison, levels=c("Kirov-NE_Poland", "Kirov-Norway", "Andujar-Donana" ))
all_popsr2N$region <- factor (all_popsr2N$region , levels=c("Telomere_2m", "Interstitial", "Centromere"))
all_popsr2$comparison <- factor (all_popsr2$comparison, levels=c("Kirov-NE_Poland", "Kirov-Norway", "Andujar-Donana" ))
all_popsr2$region <- factor (all_popsr2$region , levels=c("Telomere_2m", "Interstitial", "Centromere"))

all_popspredictN$comparison <- factor (all_popspredictN$comparison, levels=c("Kirov-NE_Poland", "Kirov-Norway", "Andujar-Donana" ))
all_popspredictN$region <- factor (all_popspredictN$region , levels=c("Telomere_2m", "Interstitial", "Centromere"))
all_popspredict$comparison <- factor (all_popspredict$comparison, levels=c("Kirov-NE_Poland", "Kirov-Norway", "Andujar-Donana" ))
all_popspredict$region <- factor (all_popspredict$region , levels=c("Telomere_2m", "Interstitial", "Centromere"))


# Plot
ggplot(data = data.frame(all_popsr2N), aes(x = comparison, y = region, fill= r.squaredN)) + 
  geom_tile() +
  facet_wrap(~index) +
  scale_fill_gradient(low = "white", high = "dodgerblue4")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  theme_minimal() +
ggsave(paste(wd_output, "all_popsr2N_heatmap_regions_comparisons_normalized_across_regions.pdf", sep=""), width = 160, height = 160, units = "mm")

ggplot(data = data.frame(all_popsr2), aes(x = comparison, y = region, fill= r.squared)) + 
  geom_tile() +
  facet_wrap(~index) +
  scale_fill_gradient(low = "white", high = "dodgerblue4")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  theme_minimal() +
ggsave(paste(wd_output, "all_popsr2_heatmap_regions_comparisons_non_normalized.pdf", sep=""), width = 160, height = 160, units = "mm")


ggplot(data = data.frame(all_popspredictN), aes(x = comparison, y = region, fill= predictorN)) + 
  geom_tile() +
  facet_wrap(~index) +
  scale_fill_gradient(low = "white", high = "dodgerblue4")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
...
ggsave(paste(wd_output, "all_popspredictN_heatmap_regions_comparisons_normalized_across_regions.pdf", sep=""), width = 160, height = 160, units = "mm")

ggplot(data = data.frame(all_popspredict), aes(x = comparison, y = region, fill= predictor)) + 
  geom_tile() +
  facet_wrap(~index) +
  scale_fill_gradient(low = "white", high = "dodgerblue4")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  theme_minimal() +
 # geom_text(aes(label=formatC(predictor, format = "e", digits = 2),angle=45))
ggsave(paste(wd_output, "all_popspredict_heatmap_regions_comparisons_non_normalized.pdf", sep=""), width = 160, height = 160, units = "mm")

...
## Load data
```{r}
c_ll_ki_n013_diversity <- read.csv(paste(wd, "c_ll_ki_n013_diversity.csv", sep=""), header=T, na.strings = c("NA", "na"),  stringsAsFactors = F, row.names=NULL)%>% 
  mutate (., color =  viridis_pal()(5)[1])

c_ll_no_n008_diversity <- read.csv(paste(wd, "c_ll_no_n008_diversity.csv", sep=""), header=T, na.strings = c("NA", "na"),  stringsAsFactors = F, row.names=NULL)%>% 
  mutate (., color = viridis_pal()(5)[2])

c_ll_po_n008_diversity <- read.csv(paste(wd, "c_ll_po_n008_diversity.csv", sep=""), header=T, na.strings = c("NA", "na"),  stringsAsFactors = F, row.names=NULL)%>% 
  mutate (., color =  viridis_pal()(5)[3])
          
c_lp_sm_n019_diversity <- read.csv(paste(wd, "c_lp_sm_n019_diversity.csv", sep=""), header=T, na.strings = c("NA", "na"),  stringsAsFactors = F, row.names=NULL)%>% 
  mutate (., color =  "#5DC863FF")

c_lp_do_n012_diversity <- read.csv(paste(wd, "c_lp_do_n012_diversity.csv", sep=""), header=T, na.strings = c("NA", "na"),  stringsAsFactors = F, row.names=NULL)%>% 

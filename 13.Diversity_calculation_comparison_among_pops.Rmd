...
## Effect size
effect_size_rvis_score <-with(DATAFRAME_filtered %>%  filter(feature=="CDS"),
       by(DATAFRAME_filtered %>%  filter(feature=="CDS"), feature,
...
ggplot(all_pops_filtered_HD_gather, aes(evolution_category,value, colour=evolution_category)) +
  ...
  ggsave(paste(wd_output,ruta_plot,"all_pops_HD_all_variables_mean_se_features_.pdf",sep=""), width = 80, height = 85, units ="mm")

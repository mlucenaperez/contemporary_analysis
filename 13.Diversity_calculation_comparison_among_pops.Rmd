...
resultados_U_Man_Whitney <- rbind(lista_results_divergence_melted, lista_results_recombination_melted, lista_results_GC_content_melted, lista_results_size)
...
GENOMIC_VARIABLES=c("divergence", "recombination_rate", "GC_content", "informative_sites.x")

...
c_ll_cr_n006/c_ll_to-c_ll_ka-c_ll_og_n008
c_ll_cr_n006/c_ll_tu_n006
c_ll_cr_n006/c_ll_ur_n006
...
c_ll_ki_n013/c_ll_to-c_ll_ka-c_ll_og_n008
c_ll_ki_n013/c_ll_tu_n006
c_ll_ki_n013/c_ll_ur_n006
...
c_ll_la_n006/c_ll_to-c_ll_ka-c_ll_og_n008
c_ll_la_n006/c_ll_tu_n006
c_ll_la_n006/c_ll_ur_n006
c_ll_la_n006/c_ll_vl_n008
c_ll_la_n006/c_ll_ya_n008
c_ll_la_n006/x_ll_ba_n003
c_ll_no_n008/c_ll_po_n008
c_ll_no_n008/c_ll_to-c_ll_ka-c_ll_og_n008
c_ll_no_n008/c_ll_tu_n006
c_ll_no_n008/c_ll_ur_n006
c_ll_no_n008/c_ll_vl_n008
c_ll_no_n008/c_ll_ya_n008
c_ll_no_n008/x_ll_ba_n003
c_ll_po_n008/c_ll_to-c_ll_ka-c_ll_og_n008
c_ll_po_n008/c_ll_tu_n006
c_ll_po_n008/c_ll_ur_n006
c_ll_po_n008/c_ll_vl_n008
c_ll_po_n008/c_ll_ya_n008
c_ll_po_n008/x_ll_ba_n003
c_ll_to-c_ll_ka-c_ll_og_n008/c_ll_tu_n006
c_ll_to-c_ll_ka-c_ll_og_n008/c_ll_ur_n006
c_ll_to-c_ll_ka-c_ll_og_n008/c_ll_vl_n008
c_ll_to-c_ll_ka-c_ll_og_n008/c_ll_ya_n008
c_ll_to-c_ll_ka-c_ll_og_n008/x_ll_ba_n003
c_ll_tu_n006/c_ll_ur_n006
c_ll_tu_n006/c_ll_vl_n008
c_ll_tu_n006/c_ll_ya_n008
c_ll_tu_n006/x_ll_ba_n003
c_ll_ur_n006/c_ll_vl_n008
c_ll_ur_n006/c_ll_ya_n008
c_ll_ur_n006/x_ll_ba_n003
...
scp mlucena@genomics-b.ebd.csic.es:/home/mlucena/ANGSD_analysis/intergenic_analysis/intergenic_fst/*.fsts.csv /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/intergenic_analysis/analysis_fst
...
plot_FST_nj_weighted_unrooted_tree <- function(wd,df,filter_pattern,subset_name ){
  ...
  ## plot Neighbouring-Joining Tree
    ...
    pdf(paste0(wd,subset_name, gsub(".fsts.csv", "_weighted.pdf",df)))
...
for (i in 1:length (fst_table)){
  #Load table,  keep only the values of single populations (NOT NOW! because I have Mongolia, if you want to do that only remove the # in the function).
...
df <- fst_table
filter_pattern <- "_ll_"
subset_name <- "lynx_lynx_fst_test"
...
fst.w_matrix_fancy <- fst.w_matrix %>%  plyr::rename(c( "c_ll_po_n008"= "Bialowieza",
                          "c_ll_ur_n006"= "Urals",
                          "c_ll_ki_n013"= "Kirov",
                          "c_ll_la_n006"= "Latvia",
                          "c_ll_no_n008"= "Norway",
                          "x_ll_ba_n003"= "Balkans" ,
                          "c_ll_cr_n006"= "Carpathians",
                          "c_ll_to-c_ll_ka-c_ll_og_n008"= "Mongolia",
                          "c_ll_tu_n006"= "Tuva",
                          "c_ll_vl_n008"= "Vladivostok", 
                          "c_ll_ya_n008"= "Yakutia") )



# You have to give the vector in the correct order check it doing : distance_nj_matrix$tip.label
...
distance_nj_matrix <- nj(as.dist(t(fst.w_matrix_fancy)))

pdf(paste0(wd,subset_name, gsub(".fsts.csv", "_weighted_fancy.pdf",df)))
plot.phylo(distance_nj_matrix, type = "u" , tip.col = cols, rotate.tree = -110, lab4ut="axial", edge.width=3)
dev.off()

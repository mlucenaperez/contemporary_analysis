...
ggplot() +
  ...
  values = cols) +  
scaleBar(lon = 138, lat = 27, distanceLon = 1000, distanceLat = 10, distanceLegend = 200, dist.unit = "km", orientation = FALSE) +
  # geom_segment(data = merge(PC_coordinates, PCA_procrustes, by = 'Ind'), 
   #            aes(x = longitude, xend = X1, y = latitude, yend = X2)) +
  guides(fill = FALSE)
ggsave(paste("/Users/marialucenaperez/Owncloud/publico/PhD/Eurasian_lynx_phylogeography/maps/",pop,"_PCA_map_with_sampling_data_no_lines.pdf", sep=""),  PCA_map)

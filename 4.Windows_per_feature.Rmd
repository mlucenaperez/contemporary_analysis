...
ggplot (head(c_ll_ki_n008_diversity_windows_auto_c_ll_no_n008_diversity_windows_auto), 
        aes(x = delta_pairwise_corrected, y = delta_watterson_corrected))+
...
ggplot(data=comparison_pops_auto_summary, aes(mean_delta_pairwise, mean_delta_watterson)) +
  ...
  ggsave (paste(wd_output,"delta_pi_vs_delta_watterson.pdf", sep=""), width = 160, height = 160, units = "mm")
...
ggplot(comparison_pops_auto, aes(x=feature, y=delta_w_delta_p, colour=comparison, fill=comparison, shape=comparison))+
  ...
  scale_fill_manual(values=c("#588C7E", "#F2AE72", "#8C4646")) +
  scale_color_manual(values=c("#588C7E", "#F2AE72", "#8C4646")) 
ggsave (paste(wd_output,"delta_delta_all_pops.pdf", sep=""), width = 160, height = 160, units = "mm")

...
# declare -A BARCODEID=( 
["CA2W6ANXX_1_1nf"]="c_ll_og_0181"  
["CA2W6ANXX_2_5nf"]="c_ll_ka_0189" 
["CA3D2ANXX_5_1nf"]="c_ll_og_0181"  
["CA3D2ANXX_5_5nf"]="c_ll_ka_0189" )
...
echo "sample_name,total_seq,total_reads,duplicates,mapped,uniq_mapped,uniq_mapped_vs_total_reads,duplicates_vs_total_reads,coverage_based_distribution" > raw.stats 
for sample in "${SAMPLELIST[@]}"
do
echo "${sample}"
NAME="${sample}"
...
echo "$NAME,$TOTAL_SEQ,$TOTAL_READS,$DUPLICATES,$MAPPED,$UNIQ_MAPPED,$UNIQ_MAPPED_vs_TOTAL_READS,$DUPLICATES_vs_TOTAL_READS,$COVERAGE_BASED_DISTRIBUTION" | sed 's/ //g' >> raw.stats 
done

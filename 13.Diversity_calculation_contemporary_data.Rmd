...
## HD ## 
  ...
  my_comparisons <- list(c("D_ND_watterson", "D_D_watterson"))
...
my_comparisons <- list(c("ND_ND_watterson", "ND_D_watterson"))
...
## HD ## 
  ...
  my_comparisons <- list(c("D_ND_pairwise", "D_D_pairwise"))
...
my_comparisons <- list(c("ND_ND_pairwise", "ND_D_pairwise"))

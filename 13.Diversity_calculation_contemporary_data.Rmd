...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.9, tip_length=0, map_signif_level=TRUE,linetype="blank",  test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.9, tip_length=0,map_signif_level=TRUE, linetype="blank",  test.args=list(alternative="less")) + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal() +
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_feature_watterson_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="greater"))  + 
  theme(strip.text.x = element_text(angle = 75)) +
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="greater"))  + 
  theme(strip.text.x = element_text(angle = 75)) +
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_pairwise)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="greater")) + # 
  theme(strip.text.x = element_text(angle = 75)) +
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="greater")) + # 
  theme(strip.text.x = element_text(angle = 75)) +
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=5, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_pairwise)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=5, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=9, tip_length=0,map_signif_level=TRUE, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_pairwise)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, tip_length=0,map_signif_level=TRUE, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, tip_length=0, map_signif_level=TRUE,linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_feature_pairwise_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal() +
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_feature_pairwise_less.pdf",sep=""))

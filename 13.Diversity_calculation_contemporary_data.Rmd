...
c_ll_ki_n013_diversity_c_ll_no_n008_diver_recomb_GC_evol_caterogy <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity_categories) 

c_ll_ki_n013_diversity_c_ll_po_n008_diver_recomb_GC_evol_caterogy <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories) 

c_lp_sm_n019_diversity_c_lp_do_n012_diver_recomb_GC_evol_caterogy <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity_categories) 
...
#### Boxplot Categories (HD,LD) vs. divergence
...
#### Boxplot Categories (HD,LD) vs. recombination
...
#### Boxplot Categories (HD,LD) vs. GC content
...
c_ll_ki_n013_c_ll_no_n008list_of_units_of_interest_HD_list <- lapply(as.list(c_ll_ki_n013_c_ll_no_n008_list_of_units_of_interest_HD), function(x) x[x != ""])
c_ll_ki_n013_c_ll_po_n008list_of_units_of_interest_HD_list <- lapply(as.list(c_ll_ki_n013_c_ll_po_n008_list_of_units_of_interest_HD), function(x) x[x != ""])
c_lp_sm_n019_c_lp_do_n012list_of_units_of_interest_HD_list <- lapply(as.list(c_lp_sm_n019_c_lp_do_n012_list_of_units_of_interest_HD), function(x) x[x != ""])
...
c_ll_ki_n013_c_ll_no_n008list_of_units_of_interest_LD_W_list <- lapply(as.list(c_ll_ki_n013_c_ll_no_n008_list_of_units_of_interest_LD_W), function(x) x[x != ""])
c_ll_ki_n013_c_ll_po_n008list_of_units_of_interest_LD_W_list <- lapply(as.list(c_ll_ki_n013_c_ll_po_n008_list_of_units_of_interest_LD_W), function(x) x[x != ""])
c_lp_sm_n019_c_lp_do_n012list_of_units_of_interest_LD_W_list <- lapply(as.list(c_lp_sm_n019_c_lp_do_n012_list_of_units_of_interest_LD_W), function(x) x[x != ""])

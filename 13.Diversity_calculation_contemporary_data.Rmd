...
for (DATAFRAME in DATAFRAMES) 
{
  ...
  ggplot(a, aes(x=Group.1, y=x)) +
    ...
    coord_flip() +
    ggsave (paste(wd_output,DATAFRAME,"_delta_watterson_skewness.pdf", sep=""))
  ...
  labs(title=paste("Mean for the Delta comparing Watterson:", POPULATION2,"vs", POPULATION1, sep =" "),
        x ="Feature", y = "Mean") +    
  coord_flip() +
  ggsave (paste(wd_output,DATAFRAME,"_delta_watterson_mean.pdf", sep=""))
  ...
  facet_wrap(~feature, scales = "free", ncol=3)+
   theme(axis.text.x = element_text(angle = 90)) +
  ggsave (paste(wd_output,DATAFRAME,"_delta_watterson_average_distribution_per_feature.pdf", sep=""))
  ...
  ggplot(b, aes(x=Group.1, y=x)) +
    ...
    labs(title=paste("Skewness for the Delta comparing pairwise:", POPULATION2,"vs", POPULATION1, sep =" "),
        x ="Feature", y = "Skewness") +    
    coord_flip() +
    ggsave (paste(wd_output,DATAFRAME,"_delta_pairwise_skewness.pdf", sep=""))
  ...
  labs(title=paste("Mean for the Delta comparing pairwise:", POPULATION2,"vs", POPULATION1, sep =" "),
        x ="Feature", y = "Mean") +    
  coord_flip() +
  ggsave (paste(wd_output,DATAFRAME,"_delta_pairwise_mean.pdf", sep=""))
  ...
  facet_wrap(~feature, scales = "free", ncol=3)+
   theme(axis.text.x = element_text(angle = 90)) +
  ggsave (paste(wd_output,DATAFRAME,"_delta_pairwise_average_distribution_per_feature.pdf", sep=""))

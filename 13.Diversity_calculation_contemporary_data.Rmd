...
tabla_data_temporal_diversity_pre  <- get(DATAFRAME) %>% 
  mutate (recombination_category = ifelse (recombination_rate <=1, "<=1",
                                   ...
                                   ifelse (recombination_rate > 3 & recombination_rate <=7, ">3&<=7",
...
# La filtro para hacer plots a posteriori. 
...
calculus_data_diversity_bootleneck_vs_non_bootleneck <- function(POP1, POP2, name_POP1, name_POP2){
  data_diversity_POP1_POP2 <- inner_join (POP1, POP2, by = c("scaffold", "start_cero_based", "end", "length", "feature", "strandness", "frame", "id_gene", "id", "region", "chr", "unique_id", "recombination_rate", "recombination_category", "type_chr")) %>%  
...
for (DATAFRAME in DATAFRAMES) 
{
  ...
  list_of_genes <- get(DATAFRAME) %>% filter(., log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)>min_bootleneck_pop_value & ratio_watterson_average>0.6 & ratio_watterson_average<1.4 & feature=="CDS") %>% select ( unique_id)

   assign(paste0(POP1, "_", POP2,"list_of_genes_of_interest_high_diversity_ratio_1_CDS"), list_of_genes)
}


# Los uno

list_genes_of_interest_lynx_lynx_high_diversity_ratio_1 <- inner_join(c_ll_ki_n013_c_ll_no_n008list_of_genes_of_interest_high_diversity_ratio_1_CDS, c_ll_ki_n013_c_ll_po_n008list_of_genes_of_interest_high_diversity_ratio_1_CDS)

list_genes_of_interest_lynx_lynx_lynx_pardinus_high_diversity_ratio_1 <- inner_join(c_ll_ki_n013_c_ll_no_n008list_of_genes_of_interest_high_diversity_ratio_1_CDS, c_ll_ki_n013_c_ll_po_n008list_of_genes_of_interest_high_diversity_ratio_1_CDS) %>% inner_join(., c_lp_sm_n019_c_lp_do_n012list_of_genes_of_interest_high_diversity_ratio_1_CDS)
...
lista_para_guardar_lynx_lynx <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% dplyr::rename (., genes_in_common_lynx_lynx=c_ll_ki_n013_c_ll_no_n008)

lista_para_guardar_lynx_lynx_lynx_pardinus <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% dplyr::rename (., genes_in_common_lynx_lynx=c_ll_ki_n013_c_ll_no_n008) %>%  inner_join (., as.data.frame(pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list), by=c("genes_in_common_lynx_lynx"="c_lp_sm_n019_c_lp_do_n012")) %>% dplyr::rename(.,genes_in_common_lynx_lynx_lynx_pardinus=genes_in_common_lynx_lynx)
...
lista_para_guardar_lynx_lynx_CDS <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% dplyr::rename (genes_in_common_lynx_lynx=c_ll_ki_n013_c_ll_no_n008)

lista_para_guardar_lynx_lynx_lynx_pardinus_CDS <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% dplyr::rename (genes_in_common_lynx_lynx=c_ll_ki_n013_c_ll_no_n008) %>%  inner_join (., as.data.frame(pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list_CDS), by=c("genes_in_common_lynx_lynx"="c_lp_sm_n019_c_lp_do_n012")) %>% dplyr::rename(genes_in_common_lynx_lynx_lynx_pardinus=genes_in_common_lynx_lynx)

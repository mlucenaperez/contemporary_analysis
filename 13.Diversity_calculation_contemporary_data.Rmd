...
a <- ggplot(data=interaction_stats__c_ll_ki_n013_stats_region_chr_c_ll_po_n008_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".y",sep=""), paste(DIVERSITY_MEASURE,".x",sep="")))+
...
b <- ggplot(data=interaction_stats__c_ll_ki_n013_stats_region_chr_c_ll_no_n008_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".y",sep=""), paste(DIVERSITY_MEASURE,".x",sep="")))+
  facet_wrap (~region, ncol=1) +
  geom_point (aes(colour=chr)) +
  scale_color_viridis_d() +
  geom_abline(colour="grey") +
...
c <- ggplot(data=interaction_stats__c_lp_sm_n019_stats_region_chr_c_lp_do_n012_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".y",sep=""), paste(DIVERSITY_MEASURE,".x",sep="")))+
  facet_wrap (~region, ncol=1) +
  geom_point (aes(colour=chr)) +
  scale_color_viridis_d() +
  geom_abline(colour="grey") +

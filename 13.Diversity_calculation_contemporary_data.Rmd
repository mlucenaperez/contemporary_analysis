...
calculus_data_diversity_bootleneck_vs_non_bootleneck(c_ll_ki_n013_autosomal_diversity,c_ll_no_n008_autosomal_diversity, deparse(substitute(c_ll_ki_n013_autosomal_diversity)),deparse(substitute(c_ll_no_n008_autosomal_diversity)))

calculus_data_diversity_bootleneck_vs_non_bootleneck(c_ll_ki_n013_sexual_diversity,c_ll_no_n008_sexual_diversity, deparse(substitute(c_ll_ki_n013_sexual_diversity)),deparse(substitute(c_ll_no_n008_sexual_diversity)))
...
calculus_data_diversity_bootleneck_vs_non_bootleneck(c_ll_ki_n013_autosomal_diversity,c_ll_po_n008_autosomal_diversity, deparse(substitute(c_ll_ki_n013_autosomal_diversity)),deparse(substitute(c_ll_po_n008_autosomal_diversity)))

calculus_data_diversity_bootleneck_vs_non_bootleneck(c_ll_ki_n013_sexual_diversity,c_ll_po_n008_sexual_diversity, deparse(substitute(c_ll_ki_n013_sexual_diversity)),deparse(substitute(c_ll_po_n008_sexual_diversity)))
...
calculus_data_diversity_bootleneck_vs_non_bootleneck(c_lp_sm_n019_autosomal_diversity,c_lp_do_n012_autosomal_diversity, deparse(substitute(c_lp_sm_n019_autosomal_diversity)),deparse(substitute(c_lp_do_n012_autosomal_diversity)))

calculus_data_diversity_bootleneck_vs_non_bootleneck(c_lp_sm_n019_sexual_diversity,c_lp_do_n012_sexual_diversity, deparse(substitute(c_lp_sm_n019_sexual_diversity)),deparse(substitute(c_lp_do_n012_sexual_diversity)))
...
DATAFRAMES=c("data_diversity_c_ll_ki_n013_autosomal_diversity_c_ll_no_n008_autosomal_diversity", "data_diversity_c_ll_ki_n013_autosomal_diversity_c_ll_po_n008_autosomal_diversity", "data_diversity_c_lp_sm_n019_autosomal_diversity_c_lp_do_n012_autosomal_diversity", "data_diversity_c_ll_ki_n013_sexual_diversity_c_ll_no_n008_sexual_diversity", "data_diversity_c_ll_ki_n013_sexual_diversity_c_ll_po_n008_sexual_diversity", "data_diversity_c_lp_sm_n019_sexual_diversity_c_lp_do_n012_sexual_diversity")
...
ratio_watterson_average_summary <- ratio_watterson_average  %>% 
    ...
    chr_type=ifelse((as.character(get(DATAFRAME) %>% select (chr) %>% .[1,1])) == "chrX","sexual","autosomal")
...
ratio_boot_c_ll_ki_n013_c_ll_no_n008_feature <- rbind (ratio_boot_autosomal_c_ll_ki_n013_c_ll_no_n008_feature, ratio_boot_sexual_c_ll_ki_n013_c_ll_no_n008_feature)

ratio_boot_c_ll_ki_n013_c_ll_po_n008_feature <- rbind (ratio_boot_autosomal_c_ll_ki_n013_c_ll_po_n008_feature, ratio_boot_sexual_c_ll_ki_n013_c_ll_po_n008_feature)

ratio_boot_c_lp_sm_n019_c_lp_do_n012_feature <- rbind (ratio_boot_autosomal_c_lp_sm_n019_c_lp_do_n012_feature, ratio_boot_sexual_c_lp_sm_n019_c_lp_do_n012_feature)

...
bootleneck_vs_non_bootleneck_ratio_median_feature_chr <- function(dataframe_POP1, dataframe_POP2, name_POP1, name_POP2){
  ...
  ratio_averages_POP1_POP2 <- full_join ( select ( dataframe_POP1, feature, pop, chr, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          select ( dataframe_POP2, feature, pop, chr, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          by=c("chr", "feature")) 
  
  dataframename <- paste ("interaction_stats_", name_POP1, name_POP2,  sep="_")
  assign (dataframename, ratio_averages_POP1_POP2,.GlobalEnv)
...
bootleneck_vs_non_bootleneck_ratio_median_feature_region <- function(dataframe_POP1, dataframe_POP2, name_POP1, name_POP2){
  ...
  # Create interaction table:
  ratio_averages_POP1_POP2 <- full_join ( select ( dataframe_POP1, feature, pop, region, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          select ( dataframe_POP2, feature, pop, region, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          by=c("region", "feature")) 
...
bootleneck_vs_non_bootleneck_ratio_median_region_chr <- function(dataframe_POP1, dataframe_POP2, name_POP1, name_POP2){
  ...
  # Create interaction table:
  ratio_averages_POP1_POP2 <- full_join ( select ( dataframe_POP1, chr, pop, region, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          select ( dataframe_POP2, chr, pop, region, total_count, wmean_watterson_ave, wmean_pairwise_ave, wmean_tajimaD), 
                                          by=c("region", "chr")) 
...
DIVERSITY_MEASURES=c("wmean_watterson_ave", "wmean_pairwise_ave")

  for (DIVERSITY_MEASURE in DIVERSITY_MEASURES)
{
    
a <- ggplot(data=interaction_stats__c_ll_ki_n013_stats_region_chr_c_ll_po_n008_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".x",sep=""), paste(DIVERSITY_MEASURE,".y",sep="")))+
...
b <- ggplot(data=interaction_stats__c_ll_ki_n013_stats_region_chr_c_ll_no_n008_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".x",sep=""), paste(DIVERSITY_MEASURE,".y",sep="")))+
  facet_wrap (~region, ncol=1) +
  geom_point (aes(colour=chr)) +
  scale_color_viridis_d() +
  geom_abline(colour="grey") +
...
c <- ggplot(data=interaction_stats__c_lp_sm_n019_stats_region_chr_c_lp_do_n012_stats_region_chr %>% filter(chr!="chrX"), mapping = aes_string(paste(DIVERSITY_MEASURE,".x",sep=""), paste(DIVERSITY_MEASURE,".y",sep="")))+
  facet_wrap (~region, ncol=1) +
  geom_point (aes(colour=chr)) +
  scale_color_viridis_d() +
  geom_abline(colour="grey") +
...
a.b.c <- ggarrange(a, b, c,  
          labels = c("A", "B" ,"C"),
          ncol = 3, nrow = 1, widths=c(1,1,1.25))
  
ggsave (paste(wd_output,"comparisons_region_vs_chr_",DIVERSITY_MEASURE, ".pdf", sep=""),a.b.c, width = 25, height = 25, units = "cm")

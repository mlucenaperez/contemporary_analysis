...
# ----------
## Population metrics
Esto no tengo que correlo. Puedo cargar las tablas. 
...
```{r}
stats_df_pop <- read.table(paste(wd_output,"stats_diversity_per_pop.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_feature <- read.table(paste(wd_output,"stats_diversity_per_pop_per_feature.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_region <- read.table(paste(wd_output,"stats_diversity_per_pop_per_region.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_chr <- read.table(paste(wd_output,"stats_diversity_per_pop_per_chr.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_recomb <- read.table(paste(wd_output,"stats_diversity_per_pop_per_recomb.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_feature_chr <- read.table(paste(wd_output,"stats_diversity_per_pop_per_feature_chr.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_region_chr <- read.table(paste(wd_output,"stats_diversity_per_pop_per_region_chr.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_recomb_chr <- read.table(paste(wd_output,"stats_diversity_per_pop_per_recomb_chr.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_feature_region <- read.table(paste(wd_output,"stats_diversity_per_pop_per_feature_region.tsv",sep=""), row.names = NULL, sep =";", dec="," )
stats_df_pop_feature_recomb <- read.table(paste(wd_output,"stats_diversity_per_pop_per_feature_recomb.tsv",sep=""),row.names = NULL, sep =";", dec="," )
stats_df_pop_region_recomb <- read.table(paste(wd_output,"stats_diversity_per_pop_per_region_recomb.tsv",sep=""), row.names = NULL, sep =";", dec="," )
...
```{r}
ggplot() + 
  geom_point (data=subset(stats_df_pop_autosomes_feature, !is.na(feature)), 
              aes(x=feature, y=wmean_watterson_ave, fill=Populations, colour=Populations)) +
  geom_segment (data=subset(stats_df_pop_autosomes_feature, !is.na(feature)), 
...
ggplot() + 
  geom_point (data=subset(stats_df_pop_chrX_feature, !is.na(feature)), 
              aes(x=feature, y=wmean_watterson_ave, fill=Populations, colour=Populations)) +
  geom_segment (data=subset(stats_df_pop_chrX_feature, !is.na(feature)), 
                aes(x = feature, xend=feature, y = wmean_watterson_ave-se_wmean_watterson_boot, yend = wmean_watterson_ave+se_wmean_watterson_boot, colour=Populations)) +
  scale_colour_manual(values = cols) +
  scale_fill_manual(values = cols) +
  facet_wrap(~Species, ncol=1, scales="free_y") +
...
ggplot() + 
  geom_point (data=subset(stats_df_pop_autosomes_feature_region, !is.na(feature)), 
              aes(x=feature, y=wmean_watterson_ave, fill=Populations, colour=Populations)) +
  geom_segment (data=subset(stats_df_pop_autosomes_feature_region, !is.na(feature)), 
                aes(x = feature, xend=feature, y = wmean_watterson_ave-se_wmean_watterson_boot, yend = wmean_watterson_ave+se_wmean_watterson_boot, colour=Populations)) +
  scale_colour_manual(values = cols) +
  scale_fill_manual(values = cols) +
  facet_wrap(region~Populations, ncol=3, scales="free_y") +
...
```{r}
ggplot() + 
  geom_point (data=subset(stats_df_pop_autosomes_region, !is.na(region)), 
              aes(x=region, y=wmean_watterson_ave, fill=Populations, colour=Populations)) +
  geom_segment (data=subset(stats_df_pop_autosomes_region, !is.na(region)), 

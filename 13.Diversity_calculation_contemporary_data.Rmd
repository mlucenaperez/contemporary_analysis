...
skeweness_watterson$Group.1 <- factor (skeweness_watterson$Group.1, levels=c("Kirov-Norway", "Kirov-NE_Poland", "Andujar-Donana"))
  ...
  ggplot(skeweness_watterson, aes(x=Group.2, y=x, fill=Group.1, color=Group.1, shape=Group.1)) +
    geom_point() +
...
ggplot(skeweness_pairwise, aes(x=Group.2, y=x, fill=Group.1, color=Group.1, shape=Group.1)) +
    geom_point() +
...
lista_results_divergence_melted <- melt(list(divergence.greater , divergence.less)) %>% mutate(genomic_variable="divergence")
lista_results_recombination_melted <- melt(list(recombination.greater, recombination.less)) %>% mutate(genomic_variable="recombination")
lista_results_GC_content_melted <- melt(list(GC_content.greater, GC_content.less)) %>% mutate(genomic_variable="GC_content")
...
write.table(format(resultados_U_Man_Whitney, digits=8, scientific=T), paste(wd_output,DATAFRAME,"_results_features_UMW_test.txt",sep=""), row.names = F)
...
lista_divergence <- melt(list(divergence.greater, divergence.less)) %>% mutate(genomic_variable="divergence")

# Recombination

recombination.greater <- wilcox.test(recombination_rate ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_watterson, conf.int = TRUE, alternative = "greater") %>%  tidy(.)
recombination.less <- wilcox.test(recombination_rate ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_watterson, conf.int = TRUE, alternative = "less") %>%  tidy(.)
lista_recombination <- melt(list(recombination.greater, recombination.less)) %>% mutate(genomic_variable="recombination")

# GC content
GC_content.greater <- wilcox.test(GC_content ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_watterson, conf.int = TRUE, alternative = "greater") %>%  tidy(.)
GC_content.less <- wilcox.test(GC_content ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_watterson, conf.int = TRUE, alternative = "less") %>%  tidy(.)
lista_GC_content <- melt(list(GC_content.greater, GC_content.less)) %>% mutate(genomic_variable="GC_content")
...
write.table(format(resultados_U_Man_Whitney, digits=8, scientific=T), paste(wd_output,DATAFRAME,"_results_UMW_test.txt",sep=""), row.names = F)
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.0075, tip_length=0, linetype="blank", test.args=list(alternative="less")) + 
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_blank()) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_watterson)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less"))  + 
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.0075, tip_length=0, linetype="blank", test.args=list(alternative="less"))  + 
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_blank()) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_watterson)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less"))  + 
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  #stat_summary(fun.y = mean, geom="point", size=3) +
  #stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.0075, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # 
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_blank()) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_features_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_watterson)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_watterson)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # 
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_features_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.0075, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # 
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_blank()) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_features_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_watterson)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # 
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_features_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=9, tip_length=0,map_signif_level=TRUE, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_watterson)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_watterson)*2.1, tip_length=0,map_signif_level=TRUE, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=9, tip_length=0, map_signif_level=TRUE,linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_watterson)*2.1, tip_length=0, map_signif_level=TRUE,linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_feature_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.8, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  scale_colour_viridis_d(option="cividis") +
  coord_cartesian(ylim = c(0,max(sts_HD_watterson)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_watterson)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(aes(colour=evolution_category),fun.data = "mean_cl_boot", size = 0.5) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.8, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_watterson_alternative_less.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  geom_boxplot(aes(colour=evolution_category),outlier.shape = NA) +
  scale_colour_viridis_d(option="cividis") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_watterson)*2.1, tip_length=0, linetype="blank", test.args=list(alternative="less")) + # test.args=list(alternative="less")
  
  theme(strip.text.x = element_text(angle = 75)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_watterson_alternative_less.pdf",sep=""))
...
recombination.greater <- wilcox.test(recombination_rate ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_pairwise, conf.int = TRUE, alternative = "greater") %>%  tidy(.)
recombination.less <- wilcox.test(recombination_rate ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_pairwise, conf.int = TRUE, alternative = "less") %>%  tidy(.)
lista_recombination <- melt(list(recombination.greater, recombination.less)) %>% mutate(genomic_variable="recombination")

# GC content
GC_content.greater <- wilcox.test(GC_content ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_pairwise, conf.int = TRUE, alternative = "greater") %>%  tidy(.)
GC_content.less <- wilcox.test(GC_content ~ diversity_category, data = data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories_pairwise, conf.int = TRUE, alternative = "less") %>%  tidy(.)
lista_GC_content <- melt(list(GC_content.greater, GC_content.less)) %>% mutate(genomic_variable="GC_content")

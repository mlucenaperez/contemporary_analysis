...
```{r}
ggplot() + 
  geom_point (data=subset(stats_df_pop_autosomes_recomb_category, !is.na(discrete_recomb)), 
              aes(x=discrete_recomb, y=wmean_watterson_ave, fill=Populations, colour=Populations)) +
  geom_segment (data=subset(stats_df_pop_autosomes_recomb_category, !is.na(discrete_recomb)), 

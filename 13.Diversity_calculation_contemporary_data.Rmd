...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"feature_categories_vs_watterson_autosomes.pdf",sep=""))
...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"feature_categories_vs_pairwise_autosomes.pdf",sep=""))
...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"feature_categories_vs_watterson_chrX.pdf",sep=""))
...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"feature_categories_vs_pairwise_chrX.pdf",sep=""))
...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"chr_vs_watterson.pdf",sep=""))
...
ggplot() + 
  ...
  facet_wrap(~Species, ncol=1, scales="free_y") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
  ggsave(paste(wd_output,"chr_vs_pairwise.pdf",sep=""))

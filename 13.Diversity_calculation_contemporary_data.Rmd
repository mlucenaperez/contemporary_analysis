...
for (DATAFRAME in DATAFRAMES) 
{
  ...
  assign(paste0(POP1, "_", POP2,"_list_of_genes_of_interest_high_diversity_ratio_1_CDS_watterson"), list_of_genes_GOterm)
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.0075, tip_length=0, linetype="blank") + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_features_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_features_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_features_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_features_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=5, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=5, tip_length=0, linetype="blank") + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=9, tip_length=0,map_signif_level=TRUE, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD_watterson)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_watterson)*2.1, tip_length=0,map_signif_level=TRUE, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=9, tip_length=0, map_signif_level=TRUE,linetype="blank") + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,recombination_rate)) +
  ...
  facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_watterson)*2.1, tip_length=0, map_signif_level=TRUE,linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.8, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.8, tip_length=0, linetype="blank") + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=0.9, tip_length=0, map_signif_level=TRUE,linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=0.9, tip_length=0,map_signif_level=TRUE, linetype="blank") + # test.args=list(alternative="less")  map_signif_level=TRUE, 
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_feature_watterson.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_watterson")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal() +
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_feature_watterson.pdf",sep=""))
...
for (DATAFRAME in DATAFRAMES) 
{
  ...
  assign(paste0(POP1, "_", POP2,"_list_of_genes_of_interest_high_diversity_ratio_1_CDS_pairwise"), list_of_genes_GOterm)
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  #facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_features_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD_pairwise)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_features_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_features_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,divergence)) +
  ...
  facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_features_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD_pairwise)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD_pairwise)*2.1, tip_length=0,map_signif_level=TRUE, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,recombination_rate)) +
  ...
  facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD_pairwise)*2.1, tip_length=0, map_signif_level=TRUE,linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_feature_pairwise.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD_pairwise")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_feature_pairwise.pdf",sep=""))

...
stats_df_pop_autosomes_recomb_chr <- diversity_stats_doble_grouped(data_diversity_filtered_ave_corrected %>% filter (type_chr=="autosomes"),  "discrete_recomb", "chr") %>%  mutate (type_chr="autosomes")
...
stats_df_pop_chrX_recomb_chr <- diversity_stats_doble_grouped(data_diversity_filtered_ave_corrected %>% filter (type_chr=="chrX"),  "discrete_recomb", "chr") %>%  mutate (type_chr="chrX")

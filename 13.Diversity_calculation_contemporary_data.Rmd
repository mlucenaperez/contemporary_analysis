...
for (DATAFRAME in DATAFRAMES) 
{
  ...
  list_of_genes_D_D <- get(DATAFRAME) %>% filter(., log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)>min_bootleneck_pop_value & feature=="CDS") %>% select ( unique_id)
  
  assign(paste0(POP1, "_", POP2,"_list_CDS_D_D"), list_of_genes_D_D)
  
  list_of_intergenic_D_D <-  get(DATAFRAME) %>% filter(., log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)>min_bootleneck_pop_value & feature=="Intergenic") %>% select ( unique_id)
  
  assign(paste0(POP1, "_", POP2,"_list_intergenic_D_D"), list_of_intergenic_D_D)
  
  
  ## DATASET ND-D
      
  list_of_genes_ND_D <- get(DATAFRAME) %>% filter(., log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)<min_bootleneck_pop_value & feature=="CDS") %>% select ( unique_id)
  assign(paste0(POP1, "_", POP2,"_list_CDS_ND_D"), list_of_genes_ND_D)
...
######
  ...
  mutate (evolution_category=
            ifelse (log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)>min_bootleneck_pop_value, "D-D",
            ifelse (log(watterson_ave.x)>min_non_bootleneck_pop_value & log(watterson_ave.y)<min_bootleneck_pop_value, "ND-D",
            ifelse (log(watterson_ave.x)<min_non_bootleneck_pop_value & log(watterson_ave.y)<min_bootleneck_pop_value, "ND-ND",
            ifelse (log(watterson_ave.x)<min_non_bootleneck_pop_value & log(watterson_ave.y)>min_bootleneck_pop_value, "D-ND",NA))))) %>% 
...
data_diversity_categories$evolution_category <- factor (data_diversity_categories$evolution_category, levels=c("D-ND", "D-D", "ND-ND", "ND-D"))
...
colnames(c_ll_ki_n013_c_ll_no_n008_list_CDS_D_D) <- "c_ll_ki_n013_c_ll_no_n008_D_D"
colnames(c_ll_ki_n013_c_ll_po_n008_list_CDS_D_D) <- "c_ll_ki_n013_c_ll_po_n008_D_D"
colnames(c_lp_sm_n019_c_lp_do_n012_list_CDS_D_D) <- "c_lp_sm_n019_c_lp_do_n012_D_D"


# Los que son D-D en todas las poblaciones: Intergenic

colnames(c_ll_ki_n013_c_ll_no_n008_list_intergenic_D_D) <- "c_ll_ki_n013_c_ll_no_n008_D_D"
colnames(c_ll_ki_n013_c_ll_po_n008_list_intergenic_D_D) <- "c_ll_ki_n013_c_ll_po_n008_D_D"
colnames(c_lp_sm_n019_c_lp_do_n012_list_intergenic_D_D) <- "c_lp_sm_n019_c_lp_do_n012_D_D"

# Los que son ND-D en todas las poblaciones: Intergenic

colnames(c_ll_ki_n013_c_ll_no_n008_list_CDS_ND_D) <- "c_ll_ki_n013_c_ll_no_n008_ND_D"
colnames(c_ll_ki_n013_c_ll_po_n008_list_CDS_ND_D) <- "c_ll_ki_n013_c_ll_po_n008_ND_D"
colnames(c_lp_sm_n019_c_lp_do_n012_list_CDS_ND_D) <- "c_lp_sm_n019_c_lp_do_n012_ND_D"
...
c_ll_ki_n013_c_ll_no_n008_list_CDS_D_D_list <- lapply(as.list(c_ll_ki_n013_c_ll_no_n008_list_CDS_D_D), function(x) x[x != ""])
c_ll_ki_n013_c_ll_po_n008_list_CDS_D_D_list <- lapply(as.list(c_ll_ki_n013_c_ll_po_n008_list_CDS_D_D), function(x) x[x != ""])
c_lp_sm_n019_c_lp_do_n012_list_CDS_D_D_list <- lapply(as.list(c_lp_sm_n019_c_lp_do_n012_list_CDS_D_D), function(x) x[x != ""])

ll_lp_list_CDS_D_D <- c(c_ll_ki_n013_c_ll_no_n008_list_CDS_D_D_list, c_ll_ki_n013_c_ll_po_n008_list_CDS_D_D_list, c_lp_sm_n019_c_lp_do_n012_list_CDS_D_D_list)


# Intergenic
c_ll_ki_n013_c_ll_no_n008_list_intergenic_D_D_list <- lapply(as.list(c_ll_ki_n013_c_ll_no_n008_list_intergenic_D_D), function(x) x[x != ""])
c_ll_ki_n013_c_ll_po_n008_list_intergenic_D_D_list <- lapply(as.list(c_ll_ki_n013_c_ll_po_n008_list_intergenic_D_D), function(x) x[x != ""])
c_lp_sm_n019_c_lp_do_n012_list_intergenic_D_D_list <- lapply(as.list(c_lp_sm_n019_c_lp_do_n012_list_intergenic_D_D), function(x) x[x != ""])

ll_lp_list_intergenic_D_D <- c(c_ll_ki_n013_c_ll_no_n008_list_intergenic_D_D_list, c_ll_ki_n013_c_ll_po_n008_list_intergenic_D_D_list, c_lp_sm_n019_c_lp_do_n012_list_intergenic_D_D_list)
...
venn.plot <- venn.diagram(VENN.LIST , 
                          ...
                          alpha=c(0.3,0.3, 0.3), 
                          cat.fontface=4, main="Genes with diversity in bottleneck & non-bottleneck")
...
VENN.LIST <- ll_lp_list_intergenic_D_D
venn.plot <- venn.diagram(VENN.LIST , 
                          filename = NULL,
                          scaled = TRUE,
                          fill=c("palegreen", "steelblue1", "pink"), 
                          ...
                          print.mode=c("raw", "percent"),
                          alpha=c(0.3,0.3, 0.3), 
                          cat.fontface=4, main="Intergenic with diversity in bottleneck & non-bottleneck")
...
write.table(div_recom_GC_by_categ_summary, paste0(wd_output,paste0("stats_diversity_comparison_",POP1, "_", POP2,"_genomic_variables.csv") ), quote = F, row.names=F )
...
c_ll_ki_n013_diversity_c_ll_no_n008_diver_recomb_GC_evol_category <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity_categories) 

c_ll_ki_n013_diversity_c_ll_po_n008_diver_recomb_GC_evol_category <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories) 

c_lp_sm_n019_diversity_c_lp_do_n012_diver_recomb_GC_evol_category <- divergence_recomb_and_GC_by_evol_category(data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity_categories) 
...
write.table(div_recom_GC_by_categ_summary_feature, paste0(wd_output,paste0("stats_diversity_comparison_",POP1, "_", POP2,"_genomic_variables_per_feature.csv") ), quote = F, row.names=F )
...
assign(paste0("stats_data_diversity_",POP1, "_diversity_", POP2,"_diversity_categories"), diversity_comparison_stats_df)
  
write.table(diversity_comparison_stats_df, paste0(wd_output,paste0("stats_diversity_comparison_",POP1, "_", POP2,"_number_per_feature.csv") ), quote = F, row.names=F )
...
c_ll_ki_n013_diversity_c_ll_no_n008_diver_recomb_GC_evol_caterogy_by_feature <- divergence_recomb_and_GC_by_evol_category_by_feature(data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity_categories) 

c_ll_ki_n013_diversity_c_ll_po_n008_diver_recomb_GC_evol_caterogy_by_feature <- divergence_recomb_and_GC_by_evol_category_by_feature(data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity_categories) 

c_lp_sm_n019_diversity_c_lp_do_n012_diver_recomb_GC_evol_caterogy_by_feature <- divergence_recomb_and_GC_by_evol_category_by_feature(data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity_categories) 
...
## HD ## 
  ...
  my_comparisons <- list(c("D-ND", "D-D"))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,divergence)) +
  ...
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,divergence)) +
  #facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD)*2.1, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD.pdf",sep=""))
...
my_comparisons <- list(c("ND-ND", "ND-D"))

  ## Mean LD ##

ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,divergence)) +
  coord_cartesian(ylim = c(0,0.008)) +
  #facet_grid(col = vars(feature) ) +
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD.pdf",sep=""))


  ## Boxplot LD ##

ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,divergence)) +
  coord_cartesian(ylim = c(0,max(sts_LD)*2.3)) +
  #facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD)*2.1, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_HD_features.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,divergence)) +
  ...
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_HD_features.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,divergence)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_mean_se_LD_features.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,divergence)) +
  ...
  facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD)*2.1, map_signif_level=TRUE, tip_length=0, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_divergence_boxplot_LD_features.pdf",sep=""))
...
## HD ## 
  ...
  ## Mean HD ##
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,recombination_rate)) +
  coord_cartesian(ylim = c(0,5)) +
  #facet_grid(col = vars(feature) ) +
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_HD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,recombination_rate)) +
  ...
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0,max(sts_HD)*2.3)) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test",  y_position=max(sts_HD)*2.1, tip_length=0,map_signif_level=TRUE, linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_HD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,recombination_rate)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_mean_se_LD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,recombination_rate)) +
  ...
  facet_grid(col = vars(feature) ) +
  geom_boxplot(outlier.shape = NA) +
  geom_signif(comparisons = my_comparisons, test="wilcox.test", y_position=max(sts_LD)*2.1, tip_length=0, map_signif_level=TRUE,linetype="blank") + # test.args=list(alternative="less")
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_recombination_boxplot_LD_feature.pdf",sep=""))
...
## HD ## 
  ...
  ## Mean HD ##
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,GC_content)) +
  coord_cartesian(ylim = c(0,0.8)) +
  #facet_grid(col = vars(feature) ) +
  stat_summary(fun.y = mean, geom="point", size=3) +
  stat_summary(fun.data = mean_se, geom = "errorbar") +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_HD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="HD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_HD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_mean_se_LD_feature.pdf",sep=""))
...
ggplot((get(DATAFRAME) %>% filter (type_chr=="autosomes") %>% filter(diversity_category=="LD")), aes(evolution_category,GC_content)) +
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(angle = 75), axis.text.x = element_text(angle = 75, hjust = 1)) +
  ggsave(paste(wd_output,POP1,"_",POP2,"_GC_boxplot_LD_feature.pdf",sep=""))

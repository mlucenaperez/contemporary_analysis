...
data_diversity <- read.table(paste(wd_out, "global.per.unit.averages.chr.all.regions.tsv", sep=""), header=T, na.strings = c("NA", "na")) %>%  
  ...
  mutate (., watterson_ave=watterson_modif) %>% 
  select (., -watterson_modif)
...
data_diversity_filtered_autosomes <- data_diversity_filtered %>% filter (chr!="chrX")
data_diversity_filtered_chrX <- data_diversity_filtered %>% filter (chr=="chrX")
...
# rm (autosomes_intergenic_average_values)
# rm (chrX_intergenic_average_values)
...
c_ll_ki_n013_diversity <- rbind (c_ll_ki_n013_autosomes_diversity %>% mutate(type_chr="autosomes"), c_ll_ki_n013_chrX_diversity %>% mutate(type_chr="chrX"))
c_ll_no_n008_diversity <- rbind (c_ll_no_n008_autosomes_diversity %>% mutate(type_chr="autosomes"), c_ll_no_n008_chrX_diversity %>% mutate(type_chr="chrX"))
c_ll_po_n008_diversity <- rbind (c_ll_po_n008_autosomes_diversity %>% mutate(type_chr="autosomes"), c_ll_po_n008_chrX_diversity %>% mutate(type_chr="chrX"))

c_lp_sm_n019_diversity <- rbind (c_lp_sm_n019_autosomes_diversity %>% mutate(type_chr="autosomes"), c_lp_sm_n019_chrX_diversity %>% mutate(type_chr="chrX"))
c_lp_do_n012_diversity <- rbind (c_lp_do_n012_autosomes_diversity %>% mutate(type_chr="autosomes"), c_lp_do_n012_chrX_diversity %>% mutate(type_chr="chrX"))
...
# Categorias recombinación

```{r}
# categorias de recombinación  
  mutate ()
...
cat_chr_info_filtered <- cat_chr_info %>% filter(., chr!="chrX") %>% select (SizeMb_v8, GC_content, percentage_genes, cM.Mb)
...
for (DATAFRAME in DATAFRAMES) 
{
    ...
    ggplot(data=get(DATAFRAME), aes(x=log(watterson_ave.y), y=log(watterson_ave.x), fill=feature, colour=feature)) +
...
for (DATAFRAME in DATAFRAMES) 
{
 ggplot(data=get(DATAFRAME), aes(x=log(pairwise_ave.y), y=log(pairwise_ave.x), fill=feature, colour=feature)) +
        geom_point(alpha = 1/100) +
        geom_smooth()+
    geom_abline(intercept = 0) +
   facet_wrap(~feature, scales = "free" )
...
ggplot(get(COMPARISON) %>% filter(chr!="chrX"), aes_string("recombination_rate.x", sprintf("log(%s)", INDEX))) + 
  geom_point() + 
  facet_grid(~feature)+
  geom_smooth(method = "lm")
...
ratio_pairwise_average_corrected_vs_recombination_rate_per_unit_c_ll_ki_n013_c_ll_po_n008_diversity <- lmList(log(ratio_pairwise_average_corrected) ~ recombination_rate.x | feature, data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity)
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% select (unique_id) %>% select (c_ll_ki_n013_c_ll_no_n008=unique_id) 
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% select (unique_id) %>% select (c_ll_ki_n013_c_ll_po_n008=unique_id)
...
pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012 <- data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% select (unique_id) %>% select (c_lp_sm_n019_c_lp_do_n012=unique_id)
...
lista_para_guardar_lynx_lynx <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% rename ("c_ll_ki_n013_c_ll_no_n008"="genes_in_common_lynx_lynx")

lista_para_guardar_lynx_lynx_lynx_pardinus <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% rename ("c_ll_ki_n013_c_ll_no_n008"="genes_in_common_lynx_lynx") %>%  inner_join (., as.data.frame(pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list), by=c("genes_in_common_lynx_lynx"="c_lp_sm_n019_c_lp_do_n012")) %>% rename("genes_in_common_lynx_lynx"="genes_in_common_lynx_lynx_lynx_pardinus")

                                                          
write.table(lista_para_guardar_lynx_lynx, file=paste(wd_output,"list_for_venn_lynx_lynx_ratio_above_1.txt", sep=""), quote=F, row.names = F)

write.table(lista_para_guardar_lynx_lynx_lynx_pardinus, file=paste(wd_output,"list_for_venn_lynx_lynx_lynx_pardinus_ratio_above_1.txt", sep=""), quote=F, row.names = F)
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% filter(.,feature=="CDS") %>% select (unique_id) %>% select (c_ll_ki_n013_c_ll_no_n008=unique_id) 
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS <- lapply(as.list(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008), function(x) x[x != ""])

pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% filter(.,feature=="CDS") %>% select (unique_id) %>% select (c_ll_ki_n013_c_ll_po_n008=unique_id)
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS <- lapply(as.list(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008), function(x) x[x != ""])

pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012 <- data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity %>%  filter(ratio_pairwise_average_corrected>1) %>% filter(.,feature=="CDS") %>% select (unique_id) %>% select (c_lp_sm_n019_c_lp_do_n012=unique_id)
pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list_CDS <- lapply(as.list(pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012), function(x) x[x != ""])


list_for_venn_lynx_lynx_CDS <- c(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS)

list_for_venn_lynx_lynx_lynx_pardinus_CDS <- c(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS, pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list_CDS)

lista_para_guardar_lynx_lynx_CDS <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% rename ("c_ll_ki_n013_c_ll_no_n008"="genes_in_common_lynx_lynx")

lista_para_guardar_lynx_lynx_lynx_pardinus_CDS <- inner_join (as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list_CDS), as.data.frame(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list_CDS), by=c("c_ll_ki_n013_c_ll_no_n008"="c_ll_ki_n013_c_ll_po_n008")) %>% rename ("c_ll_ki_n013_c_ll_no_n008"="genes_in_common_lynx_lynx") %>%  inner_join (., as.data.frame(pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list_CDS), by=c("genes_in_common_lynx_lynx"="c_lp_sm_n019_c_lp_do_n012")) %>% rename("genes_in_common_lynx_lynx"="genes_in_common_lynx_lynx_lynx_pardinus")

                                                          
write.table(lista_para_guardar_lynx_lynx_CDS, file=paste(wd_output,"list_for_venn_lynx_lynx_ratio_above_1_CDS.txt", sep=""), quote=F, row.names = F)

write.table(lista_para_guardar_lynx_lynx_lynx_pardinus_CDS, file=paste(wd_output,"list_for_venn_lynx_lynx_lynx_pardinus_ratio_above_1_CDS.txt", sep=""), quote=F, row.names = F)
...
# Now we can plot a Venn diagram with the VennDiagram R package, as follows:
VENN.LIST <- list_for_venn_lynx_lynx_CDS
venn.plot <- venn.diagram(VENN.LIST , 
                          filename = NULL,
                          scaled = TRUE,
                          fill=c("palegreen", "steelblue1"), 
...
VENN.LIST <- list_for_venn_lynx_lynx_lynx_pardinus_CDS
venn.plot <- venn.diagram(VENN.LIST , 
                          filename = NULL,
                          scaled = TRUE,
                          fill=c("palegreen", "steelblue1", "pink"), 
...
INDICES=c("ratio_pairwise_average_corrected", "ratio_watterson_average_corrected", "ratio_watterson_average", "ratio_pairwise_average")
...
bootleneck_vs_non_bootleneck_ratio_median_feature <- function (dataframe_POP1, dataframe_POP2, name_POP1, name_POP2){
  ...
  POP1=as.character(dataframe_POP1 %>% select (pop) %>% mutate(pop=as.character(pop)) %>% .[1,1]) 
  POP2=as.character(dataframe_POP2 %>% select (pop) %>% mutate(pop=as.character(pop)) %>% .[1,1]) 
...
ggplot (get(DATAFRAME), aes_string("feature", INDEX, fill="type_chr", colour="type_chr")) +
  ...
  ggsave(paste(wd_output, DATAFRAME,"_", INDEX,".pdf", sep=""), device=pdf)
}
}
...
{  
  for (INDEX in INDICE)
  {
    ...
    DATAFRAME$feature <- factor (DATAFRAME$feature, levels=c("UCNE","CDS","lncRNA","ncRNA","promoter_gene_1000","promoter_lncRNA_1000","3UTR","5UTR","intron","intron_lncRNA","intergenic"))
...
ratio_median_c_ll_ki_n013_stats_feature_chr_c_ll_po_n008_stats_feature_chr_cat_info <- left_join(ratio_median_c_ll_ki_n013_stats_feature_chr_c_ll_po_n008_stats_feature_chr, cat_chr_info, by="chr") %>% right_join(., filter(as.data.frame(stats_df_pop_chr), pop=="c_ll_ki_n013") %>% select(chr,mean_recombination_rate), by="chr")

ratio_median_c_ll_ki_n013_stats_feature_chr_c_ll_no_n008_stats_feature_chr_cat_info <- left_join(ratio_median_c_ll_ki_n013_stats_feature_chr_c_ll_no_n008_stats_feature_chr, cat_chr_info, by="chr") %>% right_join(., filter(as.data.frame(stats_df_pop_chr), pop=="c_ll_ki_n013") %>% select(chr,mean_recombination_rate), by="chr")

ratio_median_c_lp_sm_n019_stats_feature_chr_c_lp_do_n012_stats_feature_chr_cat_info <- left_join(ratio_median_c_lp_sm_n019_stats_feature_chr_c_lp_do_n012_stats_feature_chr, cat_chr_info, by="chr") %>% right_join(., filter(as.data.frame(stats_df_pop_chr), pop=="c_lp_sm_n019") %>% select(chr,mean_recombination_rate), by="chr")
...
ggplot (filter(get(DATAFRAME), chr!="chrX"), aes(mean_recombination_rate, ratio_median_pairwise_corrected, fill=feature, colour=feature)) +
          geom_point() +
  geom_smooth(method = "lm") +
    facet_grid(feature~.)
  ggsave(paste(wd_output, "recombination_rate_vs_",INDEX,"_",POP1,"_",POP2,"_by_feature_and_chr.pdf", sep=""), device = pdf)
...
gam1<-gam(ratio_corrected_by_watterson_average_intergenic_per_unit~+s(length)+chr+feature,data = data_diversity_c_ll_ki_n013_autosomes_diversity_c_ll_po_n008_autosomes_diversity, family = poisson)
#in the above function s() is the shorthand for fitting smoothing splines 
#in gam() function
summary(gam1)
...
# https://geneontology.github.io/docs/guide-go-evidence-codes/

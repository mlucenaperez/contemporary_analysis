...
POPS=("c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-h_ll_ba")
...
cd /home/mlucena/do_depth_european/
...
screen -S test_pca_two_sps_elena_intergenic
POP="c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba"  # <--CHANGE POP HERE
script test_pca_two_sps_elena_intergenic.log
POP="c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba"  # <--CHANGE POP HERE
...
THREADS=60                     # no. of computer cores used by bwa and samtools. 20 = OK, >20 = ask people first!
...
cat $POP*.bamlist | rev | cut -d "/"  -f 1 | cut -d "_" -f 3,4,5,6 | rev  >> $POP.ALL2.clst.borrar
echo "CLUSTER" > $POP.ALL3.clst.borrar
cat $POP*.bamlist | rev | cut -d "/"  -f 1 | cut -d "_" -f 4,5,6 | rev  >> $POP.ALL3.clst.borrar
...
scp mlucena@genomics-b.ebd.csic.es:/home/mlucena/do_depth_european/*.ALL.clst /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/analysis_PCA/test_intergenic_elena
scp mlucena@genomics-b.ebd.csic.es:/home/mlucena/do_depth_european/*.covar /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/analysis_PCA/test_intergenic_elena
...
WORKING_DIR="/Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/analysis_PCA/test_intergenic_elena/"
...
pop= c("c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-h_ll_ba_n074")
...
PC <- PC %>%  mutate(., 
         subspecies = ifelse (Pop == "c_ll_po" | Pop == "c_ll_ki" | Pop == "c_ll_la" | Pop == "c_ll_no", "Lynx_lynx_lynx",        
                          ifelse(Pop == "c_ll_ba" | Pop == "h_ll_ba", "Lynx_lynx_balcanicus" ,
                          ifelse(Pop == "c_ll_cr","Lynx_lynx_carpathicus",
                          ifelse(Pop == "c_ll_to" | Pop == "c_ll_tu" | Pop == "c_ll_ka", "Lynx_lynx_kozlovi", 
                          ifelse(Pop == "c_ll_og", "Lynx_lynx_isabellinus", 
                          ifelse(Pop == "c_ll_vl", "Lynx_lynx_stroganovi", 
                          ifelse(Pop == "c_ll_ya", "Lynx_lynx_wrangeli",     
                                 NA))))))))

cols <- c("c_ll_po"= brewer.pal(8,"Greens")[7], 
          "c_ll_ba"= brewer.pal(8,"Greens")[4], 
          "h_ll_ba"= brewer.pal(8,"Greens")[4], 
          "c_ll_cr"= brewer.pal(8,"BuGn")[6], 
          "c_ll_ki"= brewer.pal(8,"Blues")[5], 
          "c_ll_la"= brewer.pal(8,"Blues")[8], 
          "c_ll_no"= brewer.pal(8,"YlGnBu")[5], 
          "c_ll_to"= brewer.pal(8,"RdPu")[8], 
          "c_ll_tu"= brewer.pal(8,"RdPu")[5], 
          "c_ll_ka"= brewer.pal(8,"PuRd")[3], 
          "c_ll_og"= brewer.pal(8,"YlOrRd")[7], 
          "c_ll_vl"= brewer.pal(8,"YlOrRd")[5], 
          "c_ll_ya"= brewer.pal(8,"YlOrRd")[3]  )
                           
cols <- c("c_ll_po"= brewer.pal(12,"Paired")[4], 
          "c_ll_ba"= brewer.pal(12,"Paired")[2], 
          "h_ll_ba"= brewer.pal(12,"Paired")[2], 
          "c_ll_cr"= brewer.pal(12,"Paired")[1], 
          "c_ll_ki"= brewer.pal(12,"Paired")[3], 
          "c_ll_la"= brewer.pal(12,"Paired")[9], 
          "c_ll_no"= brewer.pal(12,"Paired")[10], 
          "c_ll_to"= brewer.pal(12,"Paired")[5], 
          "c_ll_tu"= brewer.pal(12,"Paired")[6], 
          "c_ll_ka"= brewer.pal(12,"Paired")[7], 
          "c_ll_og"= brewer.pal(12,"Paired")[8], 
          "c_ll_vl"= brewer.pal(12,"Paired")[11], 
          "c_ll_ya"= brewer.pal(12,"Paired")[12]  )
...
a<-ggplot() + 
  geom_point(data=PC, aes_string(x=x_axis, y=y_axis, colour="Pop"), size = 3) + 
  scale_colour_manual(values = cols)
...
ggplot() + 
  ...
  scale_shape_manual(values=1:7)
ggplot() + 
  geom_point(data=PC, aes_string(x=x_axis, y=y_axis, colour="subspecies",shape="subspecies"), size = 3)  +
  scale_shape_manual(values=1:7)

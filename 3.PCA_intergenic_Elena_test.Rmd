...
pop= c("c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba_n105")
...
ggplot() + 
 ...
 ggsave(paste(WORKING_DIR,pop, "_pca_pop.pdf", sep=""),units="mm",  width=270, height=190)
...
ggplot() + 
  ...
  ggsave(paste(WORKING_DIR,pop, "_pca_subspecies.pdf", sep=""),units="mm",  width=270, height=190)
...
POP="c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba"  # <--CHANGE POP HERE
screen -S test_pca_two_sps_elena_intergenic_mindepth1
POP="c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba"  # <--CHANGE POP HERE
script test_pca_two_sps_elena_intergenic_mindepth1.log
POP="c_ll_ba-c_ll_cr-c_ll_ka-c_ll_ki-c_ll_la-c_ll_no-c_ll_og-c_ll_po-c_ll_to-c_ll_tu-c_ll_vl-c_ll_ya-c_lp_do-c_lp_sm-h_ll_ba"  # <--CHANGE POP HERE
...
# PCA: Using just 5x iberian lynx
...
I modify manually the bam file to rm the individuals of wg reseq project!! Those are:
...
Ind == "c_lp_sm_0298" | 
Ind == "c_lp_sm_0359" | 
Ind ==  "c_lp_do_0007", "Genome_resequencing_project", 
Ind== "c_lp_sm_0221", "Candiles"

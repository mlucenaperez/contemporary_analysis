...
tar -cvzf raw_data.tar.gz raw_data && rm -R raw_data


cvzf EVA_scripts.tar.gz EVA_scripts



Sent:

tar -cvzf Lyp_annotation_Apr14_final.tar.gz Lyp_annotation_Apr14_final


tar -cvzf lynx_ancient_genomes.tar.gz lynx_ancient_genomes && rm -R lynx_ancient_genomes

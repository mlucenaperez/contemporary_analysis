...
# 
# INDICES=c("ratio_pairwise_average", "ratio_watterson_average", "ratio_corrected_by_pairwise_average_intergenic_per_unit", "ratio_corrected_by_watterson_average_intergenic_per_unit")
# 
# GROUPS=c("feature", "region", "chr")
# 
# 
...
#   for (INDEX in INDICES){
#     for (GROUP in GROUPS){
#   pdf(paste(wd_output,title,"_",GROUP,"_",INDEX,"_y_transformed.pdf", sep=""))
...
for (DATAFRAME in DATAFRAMES) 
{
 ggplot(data=get(DATAFRAME), aes(x=watterson_ave.y ,y=watterson_ave.x, fill=feature, colour=feature)) +
   ...
   facet_wrap(~feature, scales = "free" )
   ggsave (paste(wd_output,DATAFRAME,"_relation_by_feature_.pdf", sep=""))
}      

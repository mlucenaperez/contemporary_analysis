...
RUTA_INPUT=
RUTA_OUTPUT=/home/mlucena/ANGSD_analysis  

#I'll use the parameters calculated by the (depth_global_to_choose_MaxDepthGlobal.R inside previous pipeline) script:

scp /Users/marialucenaperez/Dropbox/PhD/contemporary/ANGSD/qc_test/mean_sd_depthGlobal_lynx_per_pop_mean_folds_0.95_a.csv mlucena@genomics-b.ebd.csic.es:$RUTA_OUTPUT
...
awk '{print $1"_"$2"_"$3,$4,$5,$6,$7,$8,$9,$10,$11}' mean_sd_depthGlobal_lynx_per_pop_mean_folds_2_a.csv | grep "${POP} "  > "$POP"_mean_sd_depthGlobal_lynx_per_pop_mean_folds_2_a.csv
...
##########################
#  SAF (likelihood):     # DONE FOR ALL POP
##########################

...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008 <- data_diversity_c_ll_ki_n008_diversity_c_ll_no_n008_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) %>% rename (c_ll_ki_n008_c_ll_no_n008=unique_id)
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) %>% rename (c_ll_ki_n013_c_ll_po_n008=unique_id)
 ...
 kk<- add.col(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008) 
...
library(rowr)
table_to_vehn_raw <- Map(cbind.fill, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008, MoreArgs = list(fill=NA)) %>% Map(cbind.fill, ., pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008, MoreArgs = list(fill=NA))

geneLS <- lapply(as.list(table_to_vehn_raw), function(x) x[x != ""])


pairwise_ratio_above_one_c_ll_ki_n008_c_ll_po_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) #%>% mutate (factor="c_ll_ki_n008_c_ll_po_n008")  

  
kk <- kk <- full_join(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008, by="unique_id") %>% full_join(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008 , by="unique_id")



data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity
data_diversity_c_ll_ki_n008_diversity_c_ll_po_n008_diversity
data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity
data_diversity_c_lp_sm_n012_diversity_c_lp_do_n012_diversity

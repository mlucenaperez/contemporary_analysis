...
lista_lynxpardinus <- inner_join( data_diversity_pre_sm, data_diversity_pre_do, by = c("scaffold", "start_cero_based", "end", "length", "feature", "strandness", "frame", "id_gene", "id", "region", "id_feature", "chr", "unique_id")) %>% select("unique_id")
...
data_diversity_filtered <- rbind(data_diversity_filtered_lynxlynx, data_diversity_filtered_lynxpardinus) %>% full_join (., recombination_per_unit, by = "unique_id")   
...
#### Relation between recombination and diversity

```{bash}

ggplot(data_diversity_filtered_autosomal,aes(recombination,watterson_ave))+
...
stats_df_pop_autosomal <- diversity_stats_pop(data_diversity_filtered_autosomal)
write.table(stats_df_pop_autosomal, paste(wd_output,"stats_diversity_per_pop_autosomal.tsv",sep=""),quote = F,  row.names = F, sep =";", dec="," )


stats_df_pop_sexual <- diversity_stats_pop(data_diversity_filtered_sexual)
write.table(stats_df_pop_sexual, paste(wd_output,"stats_diversity_per_pop_sexual.tsv",sep=""),quote = F,  row.names = F, sep =";", dec="," )
...
{diversity_stats_df_grouped$chr <- factor(diversity_stats_df_grouped$chr, levels = c("chrA1","chrC1","chrB1","chrA2","chrC2","chrB2","chrB3","chrB4","chrA3","chrD1","chrD3","chrD4","chrD2","chrF2","chrF1","chrE2","chrE1","chrX"))}
  ...
  dataframename <- paste(DATAFRAME,"stats_df", GROUP, sep ='_')
...
for (GROUP in GROUPS)
{
 diversity_stats_grouped(data_diversity_filtered_autosomal, GROUP) 
 diversity_stats_grouped(data_diversity_filtered_sexual, GROUP) 
}
...
## Tablas per pop
### Corregidas para la media de intergénico.
...
POPS=c("c_ll_ki_n013","c_ll_no_n008","c_ll_ki_n008","c_ll_po_n008", "c_lp_sm_n019", "c_lp_sm_n012", "c_lp_do_n012")
...
data_diversity_filtered_ave_corrected <- rbind (c_ll_ki_n013_diversity, c_ll_ki_n008_diversity, c_ll_no_n008_diversity, c_ll_po_n008_diversity,  c_lp_sm_n019_diversity, c_lp_sm_n012_diversity, c_lp_do_n012_diversity)
...
calculus_data_diversity_bootleneck_vs_non_bootleneck <- function(POP1, POP2, name_POP1, name_POP2){
  data_diversity_POP1_POP2 <- inner_join (POP1, POP2, by = c("scaffold", "start_cero_based", "end", "length", "feature", "strandness", "frame", "id_gene", "id", "region", "id_feature", "chr", "unique_id")) %>%  
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_no_n008_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) %>% rename (c_ll_ki_n013_c_ll_no_n008=unique_id) 
...
pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008 <- data_diversity_c_ll_ki_n013_diversity_c_ll_po_n008_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) %>% rename (c_ll_ki_n013_c_ll_po_n008=unique_id)
...
pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012 <- data_diversity_c_lp_sm_n019_diversity_c_lp_do_n012_diversity %>%  filter(ratio_corrected_by_pairwise_average_intergenic_per_unit>1) %>% select (unique_id) %>% rename (c_lp_sm_n019_c_lp_do_n012=unique_id)
...
list_for_venn_lynx_pardinus <- c(pairwise_ratio_above_one_c_ll_ki_n013_c_ll_no_n008_list, pairwise_ratio_above_one_c_ll_ki_n013_c_ll_po_n008_list,pairwise_ratio_above_one_c_lp_sm_n019_c_lp_do_n012_list)
...
VENN.LIST <- list_for_venn_lynx_pardinus
venn.plot <- venn.diagram(VENN.LIST , 
                          filename = "Lynx_lynx_lynx_pardinus_venn.tiff",
                          scaled = TRUE,
...
POPS=c("c_ll_ki_n013","c_ll_no_n008","c_ll_ki_n008","c_ll_po_n008", "c_lp_do_n012", "c_lp_sm_n019","c_lp_sm_n012")
...
DATAFRAMES=c(
"ratio_median_c_ll_ki_n013_ave_diversity_feature_chr_c_ll_no_n008_ave_diversity_feature_chr", "ratio_median_c_ll_ki_n013_ave_diversity_feature_chr_c_ll_po_n008_ave_diversity_feature_chr", "ratio_median_c_ll_ki_n013_ave_diversity_feature_region_c_ll_no_n008_ave_diversity_feature_region", "ratio_median_c_ll_ki_n013_ave_diversity_feature_region_c_ll_po_n008_ave_diversity_feature_region", "ratio_median_c_ll_ki_n013_ave_diversity_region_chr_c_ll_no_n008_ave_diversity_region_chr", "ratio_median_c_ll_ki_n013_ave_diversity_region_chr_c_ll_po_n008_ave_diversity_region_chr", "ratio_median_c_lp_sm_n019_ave_diversity_feature_chr_c_lp_do_n012_ave_diversity_feature_chr", "ratio_median_c_lp_sm_n019_ave_diversity_feature_region_c_lp_do_n012_ave_diversity_feature_region", "ratio_median_c_lp_sm_n019_ave_diversity_region_chr_c_lp_do_n012_ave_diversity_region_chr",


"ratio_median_c_ll_ki_n008_ave_diversity_feature_chr_c_ll_no_n008_ave_diversity_feature_chr", "ratio_median_c_ll_ki_n008_ave_diversity_feature_chr_c_ll_po_n008_ave_diversity_feature_chr", "ratio_median_c_ll_ki_n008_ave_diversity_feature_region_c_ll_no_n008_ave_diversity_feature_region", "ratio_median_c_ll_ki_n008_ave_diversity_feature_region_c_ll_po_n008_ave_diversity_feature_region", "ratio_median_c_ll_ki_n008_ave_diversity_region_chr_c_ll_no_n008_ave_diversity_region_chr", "ratio_median_c_ll_ki_n008_ave_diversity_region_chr_c_ll_po_n008_ave_diversity_region_chr", "ratio_median_c_lp_sm_n012_ave_diversity_feature_chr_c_lp_do_n012_ave_diversity_feature_chr", "ratio_median_c_lp_sm_n012_ave_diversity_feature_region_c_lp_do_n012_ave_diversity_feature_region", "ratio_median_c_lp_sm_n012_ave_diversity_region_chr_c_lp_do_n012_ave_diversity_region_chr")

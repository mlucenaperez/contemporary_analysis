...
awk -v OFS="\t" '{print $1, $2, $3, $8}' > $OUTPUT/windows_2Mb_density_functional_sites_per_unit.tsv
...
## Me lo bajo a local
```{bash}
scp -p  mlucena@genomics-b.ebd.csic.es:/GRUPOS/grupolince/mlucena/gene_density_annotation/windows_2Mb_annotated.tsv /Users/marialucenaperez/Documents/WG_genomic_variables/
```

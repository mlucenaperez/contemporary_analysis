...
java -jar /opt/picard-tools/picard.jar ValidateSamFile I=h_lp_mt_1305_sorted_rmdup_sorted_indelrealigner.bam MODE=SUMMARY MAX_OPEN_TEMP_FILES=1000 IGNORE=INVALID_MAPPING_QUALITY IGNORE=INVALID_CIGAR

/home/mlucena/atlas/atlas task=estimatePMD bam=h_lp_mt_1305_sorted_rmdup_sorted_indelrealigner.bam fasta=$REF  verbose 
